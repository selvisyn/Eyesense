...
const I18N = {
  tr: {
    ...
    heroSub:
      "Göz izleme teknolojisi ile ellerin olmadan iletişim kur, yaz, seç.",
    privacyText:
      "🔒 <b>Gizlilik önce gelir</b> — Hiçbir görüntü veya kişisel veri sunucuya gönderilmez.",
    btnStart: "👁 Kalibrasyona Başla",
    btnSaved: "▶ Kaydedilmiş Kalibrasyon",
    btnHow: "📖 Nasıl Kullanılır",
    btnDirect: "☝ Direkt Giriş",
    savedCal: "💾 Kalibrasyon: ",
    btnPhrase: "Cümle Kartları",
    btnKeyboard: "Klavye",
    btnVision: "Etrafımda Ne Var?",
    btnQuickMsg: "Hızlı Mesaj",
    btnA11y: "Erişilebilirlik",
    btnCalib: "Kalibrasyon",
    btnPanic: "PANİK",
    advToolsTitle: "🔧 Gelişmiş Araçlar",
    advDiagTitle: "Tanı",
    advDiagSub: "Teknik sorun analizi",
    advEvalTitle: "Doğruluk Testi",
    advEvalSub: "Göz izleme doğruluğunu ölç",
    advHowTitle: "Nasıl Kullanılır",
    advHowSub: "Kullanım kılavuzu",
    a11yClose: "✓ Kapat",
    a11yTitle: "♿ Erişilebilirlik",
    a11yInputTitle: "Giriş Modu",
    a11yThemeTitle: "Görsel Tema",
    a11yBlinkTitle: "Göz Kırpma & Kaydırma",
    modeEyeLabel: "Göz İzleme",
    modeEyeSub: "Göz takibi",
    modeFingerLabel: "Dokunmatik",
    modeFingerSub: "Parmak girişi",
    modeBothLabel: "Her İkisi",
    modeBothSub: "Göz + dokunmatik",
    modeDwellLabel: "Sadece Bakış",
    modeDwellSub: "Göz zamanlayıcı",
    thNLabel: "Standart",
    thNSub: "Koyu",
    thHLabel: "Yüksek Kontrast",
    thHSub: "Beyaz çerçeve",
    thLLabel: "Büyük Metin",
    thLSub: "Büyük font",
    thNiLabel: "Gece Modu",
    thNiSub: "Az ışık",
    irisScrollLabel: "Iris Kaydırma",
    blinkNavLabel: "Çift Blink = Geri",
    blinkNavSub: "Her zaman aktif",
    blinkSelectTitle: "Tek Blink = Seç",
    blinkSensTitle: "Blink Hassasiyeti",
    wakeWordTitle: "Uyandırma Komutu",
    kbSensLabelStr: "Klavye hassasiyeti: ",
    a11yDwellLabelStr: "Bekleme süresi: ",
    a11yAlphaLabelStr: "Göz yumuşatma: ",
    blinkOn: "Açık ✓",
    blinkOff: "Kapalı",
    wakeOn: "Açık ✓",
    wakeOff: "Kapalı",
    mainSub: "Bakıp bekleyin",
    menuLabel: "MENÜ",
    menuHint: "Bakıp bekle",
    smoothing: "Yumuşatma",
    dwell: "Bekleme",
    locTitle: "KONUMUNUZ",
    locLoading: "Alınıyor…",
    locDenied: "İzin verilmedi",
    locError: "Konum alınamadı",
    backBtn: "← Geri",
    backHint: "👁 Bakıp bekle · 👁👁 Çift göz kırp",
    calibStart: "Kalibrasyon başlıyor. Ekrandaki her noktaya bakın.",
    calibLook: "Noktaya bakın…",
    calibHold: "Sakin tutun…",
    calibCollect: "Veri toplanıyor…",
    calibDone: "Kalibrasyon tamamlandı.",
    calibCancelled: "Kalibrasyon iptal edildi.",
    calibLoaded: "Kalibrasyon yüklendi.",
    calibHoldStill: "Sakin tutun.",
    calibNotEnough: "Yeterli veri toplanamadı.",
    calibCounter: "Kalibrasyon",
    calibRetrying: "⚠ Yeniden deneniyor…",
    calibNext: "Sonraki.",
    calibQualGood: "İyi 👍",
    calibQualFair: "Orta",
    calibQualRetry: "Tekrar",
    calibQualLabel: "Kalite",
    calibErrHigh: "⚠ Yüksek gürültü — sakin tutun",
    calibErrPfx: "Hata: ~",
    evalDesc:
      "Hedefler sırayla çıkacak. Her hedefe bakın — dolunca ölçüm alınır.",
    evalLookTarget: "Hedefe bakın…",
    evalCounter: "Test",
    repTitle: "📊 Doğruluk Raporu",
    repBack: "Uygulamaya Dön",
    repRecal: "🔄 Yeniden Kalibre Et",
    repAvgErr: "Ort. Hata (px)",
    repStdDev: "Std. Sapma (px)",
    repP90: "90. Yüzdelik",
    repFPS: "FPS",
    repLatency: "Gecikme (ms)",
    repErrMap: "GÖZE HATA HARİTASI",
    repPilot: "📋 PİLOT ÖLÇÜMLER",
    repPass: "Geçti ✅",
    repFail: "Düşük",
    repLow: "Düşük",
    repOk: "≥20 OK",
    repHighLat: "⚠ Yüksek",
    repOkLat: "✅ ≤200ms",
    evalStart: "Doğruluk testi başlıyor.",
    evalCancelled: "Test iptal edildi.",
    evalCalibrateFirst: "Lütfen önce kalibrasyon yapın.",
    kbLang: "tr-TR",
    visionScan: "Tara ve Açıkla",
    visionAnalyzing: "Yapay zeka görüntüyü analiz ediyor…",
    visionDone: "Analiz tamamlandı",
    visionError: "Görüntü analiz edilemedi.",
    visionWaiting: "Kamera hazırlanıyor…",
    visionReady: "Hazır — Tarama butonuna bakın",
    visionRepeat: "🔊 Tekrar Dinle",
    visionCamSwitch: "🔄 Kamera",
    visionScanningAudio: "Görüntü analiz ediliyor, lütfen bekleyin.",
    apiKeyLabel:
      "🔑 Yapay Zeka Görüntü Analizi için API Anahtarı (isteğe bağlı)",
    apiKeySave: "Kaydet",
    apiKeySaved: "✅ API anahtarı kaydedildi",
    apiKeyMissing:
      "⚠ Görüntü analizi için API anahtarı gerekli. Başlangıç ekranından girin.",
    ocrScan: "Metni Tara",
    ocrAnalyzing: "Metin okunuyor…",
    ocrDone: "Metin okundu",
    ocrError: "Metin okunamadı.",
    ocrHint: "Kamerayı metne tutun — 3 saniye sonra otomatik tarar",
    ocrHintShort: "Kamerayı metne tutun…",
    ocrNoText: "Görüntüde metin bulunamadı.",
    ocrModeLabel: "Metin Oku",
    ocrDescribeLabel: "Etrafı Betimle",
    ocrCountingDown: "Taranıyor…",
    ocrReady: "Hazır — kamerayı metne tutun",
    sosMsg: "PANİK — Konum refakatçiye gönderilecek",
    sosSending: "📡 Acil bildirim gönderiliyor…",
    sosSent: "✅ Refakatçinize bildirim gönderildi",
    ...
    voiceSpeak: "Şimdi konuşun",
    voiceGot: "✓ Anlaşıldı",
    voiceNotUnderstood: "⚠ Anlaşılamadı",
    voiceTryAgain: "Tekrar deneyin",
    calibReadyLabel: "Kalibrasyon Hazır",
    loadingCameraLabel: "⏳ Kamera yükleniyor…",
    howTitle: "📖 EyeSense Nasıl Kullanılır",
    howClose: "✕ Kapat",
    howDone: "✓ Anladım — Başla!",
    how: [
      {
        t: "Giriş modunu seçin",
        d: "Başlangıç ekranında <b>Kalibrasyona Başla</b> (göz izleme) veya <b>Direkt Giriş</b> (dokunmatik mod) seçeneklerinden birini seçin. Kayıtlı kalibrasyon varsa <b>Kayıtlı Kalibrasyon</b> ile devam edebilirsiniz.",
        tag: "👁 Göz · ☝️ Dokunmatik · 💾 Kayıtlı",
        c: "blue",
      },
      {
        t: "Kalibrasyon (Göz izleme için)",
        d: "17 nokta sırayla ekranda belirecek. Her noktayı dolana kadar sabit bakın. Yaklaşık 45 saniye sürer. Kalibrasyon verisi cihazda saklanır.",
        tag: "🎯 ~45 saniye · 17 nokta",
        c: "",
      },
      {
        t: "Bakıp bekle ile seç",
        d: "Bir butona bakın ve gözünüzü sabit tutun. Sarı çubuk dolunca seçim yapılır. Bekleme süresi Erişilebilirlik ayarlarından değiştirilebilir (varsayılan 1.2s).",
        tag: "⏱ Bakın + bekleyin = seçin",
        c: "",
      },
      {
        t: "Tek göz kırpma = hızlı seç",
        d: "Erişilebilirlik ayarlarından <b>Tek Blink Seç</b>'i etkinleştirin. %8+ dwell varken tek blink ile anında seçim yapabilirsiniz.",
        tag: "😉 Blink = seç (isteğe bağlı)",
        c: "",
      },
      {
        t: "Çift göz kırpma = geri dön",
        d: "480ms içinde iki kez göz kırparak mevcut paneli kapatın ve bir önceki ekrana dönün. Her yerde çalışır — ayar gerekmez.",
        tag: "😉😉 Çift blink = geri",
        c: "",
      },
      {
        t: "Iris ile kaydırma",
        d: "Panel açıkken gözünüzü <b>üst veya alt kenara</b> getirin. Kenar bölgesine ne kadar girerseniz o kadar hızlı kayar. Cümle Kartları, Erişilebilirlik, Akıllı Ev panellerinde çalışır.",
        tag: "↕ Üst/alt kenar = kaydır",
        c: "green",
      },
      {
        t: "Cümle Kartları",
        d: "Bir kart üzerinde bakıp bekleyerek sesli okutun. <b>+</b> butonuna bakarak kendi cümlelerinizi emoji ile ekleyin veya düzenleyin.",
        tag: "💬 Bak → bekle → seslendir",
        c: "blue",
      },
      {
        t: "Klavye",
        d: "Her tuşa bakıp bekleyerek yazın. Üstteki kelime önerilerine bakıp bekleyin. <b>🔊</b> ile sesli okuma, <b>🎤</b> ile sesle yazma yapabilirsiniz.",
        tag: "⌨️ Bak-yaz · öneriler · TTS",
        c: "blue",
      },
      {
        t: "Etrafımda Ne Var?",
        d: "Kamera ile çevrenizi taratın — yapay zeka ne gördüğünü sesli olarak açıklar. API anahtarı girilirse görsel analiz, girilmezse OCR (metin okuma) modu çalışır.",
        tag: "👁 Tara → Yapay Zeka açıklar",
        c: "",
      },
      {
        t: "Hızlı Mesaj",
        d: 'Kayıtlı kişileri arayın veya hazır mesajları gönderin. Bakıp bekleyerek 📞 veya 💬 seçin. Kişileri "Kişileri Düzenle" ile özelleştirebilirsiniz.',
        tag: "📲 Ara · Mesaj Gönder",
        c: "",
      },
      {
        t: "Akıllı Ev (Smart Home)",
        d: "Cihazlara (ışık, perde, termostat vb.) bakıp bekleyerek açıp kapatın. Demo modda tamamen çalışır; gerçek cihaz için MQTT veya REST API bağlantısı gerekir.",
        tag: "🏠 Bakıp bekle = kontrol et",
        c: "",
      },
      {
        t: "Panik Butonu",
        d: "Ana menünün sağ üstündeki kırmızı butona bakıp bekleyin. Refakatçiye konumunuzu içeren acil bildirim gönderilir.",
        tag: "🆘 Uzun bak = acil bildirim",
        c: "",
      },
      {
        t: "En iyi doğruluk için ipuçları",
        d: "• Ekrandan 40–55 cm uzakta oturun · • Yüzünüze iyi ışık gelsin · • Başınızı sabit tutun · • Cihaz değiştirince yeniden kalibre edin · • Erişilebilirlik → Doğruluk Testi ile hata ölçün",
        tag: "💡 Mesafe · Işık · Sabitlik",
        c: "",
      },
    ],
  },
  en: {
    ...
    heroSub:
      "Communicate, type and select hands-free with eye-tracking technology.",
    privacyText:
      "🔒 <b>Privacy first</b> — No images or personal data ever sent to any server.",
    btnStart: "👁 Start Calibration",
    btnSaved: "▶ Use Saved Calibration",
    btnHow: "📖 How to Use",
    btnDirect: "☝ Direct Entry",
    savedCal: "💾 Calibration: ",
    btnPhrase: "Phrase Board",
    btnKeyboard: "Keyboard",
    btnVision: "What's Around Me?",
    btnQuickMsg: "Quick Message",
    btnA11y: "Accessibility",
    btnCalib: "Calibrate",
    btnPanic: "PANIC",
    advToolsTitle: "🔧 Advanced Tools",
    advDiagTitle: "Diagnostics",
    advDiagSub: "Technical issue analysis",
    advEvalTitle: "Accuracy Test",
    advEvalSub: "Measure eye tracking accuracy",
    advHowTitle: "How to Use",
    advHowSub: "User guide",
    a11yClose: "✓ Close",
    a11yTitle: "♿ Accessibility",
    a11yInputTitle: "Input Mode",
    a11yThemeTitle: "Visual Theme",
    a11yBlinkTitle: "Blink Control & Scroll",
    modeEyeLabel: "Eye Gaze",
    modeEyeSub: "Eye tracking",
    modeFingerLabel: "Touch",
    modeFingerSub: "Finger input",
    modeBothLabel: "Both",
    modeBothSub: "Eye + touch",
    modeDwellLabel: "Dwell Only",
    modeDwellSub: "Gaze timer",
    thNLabel: "Standard",
    thNSub: "Dark",
    thHLabel: "High Contrast",
    thHSub: "White border",
    thLLabel: "Large Text",
    thLSub: "Big font",
    thNiLabel: "Night Mode",
    thNiSub: "Low light",
    irisScrollLabel: "Iris Scroll",
    blinkNavLabel: "Double Blink Back",
    blinkNavSub: "Always active",
    blinkSelectTitle: "Single Blink Select",
    blinkSensTitle: "Blink Sensitivity",
    wakeWordTitle: "Wake Word",
    kbSensLabelStr: "Keyboard sensitivity: ",
    a11yDwellLabelStr: "Dwell duration: ",
    a11yAlphaLabelStr: "Gaze smoothing: ",
    blinkOn: "On ✓",
    blinkOff: "Off",
    wakeOn: "On ✓",
    wakeOff: "Off",
    mainSub: "Gaze & hold to select",
    menuLabel: "MENU",
    menuHint: "Gaze & hold",
    smoothing: "Smoothing",
    dwell: "Dwell",
    ...
    locError: "Could not get location",
    backBtn: "← Back",
    backHint: "👁 Gaze & hold · 👁👁 Double blink",
    calibStart: "Calibration starting. Look at each dot on screen.",
    calibLook: "Look at the dot…",
    calibHold: "Hold still…",
    calibCollect: "Collecting data…",
    calibDone: "Calibration complete.",
    calibCancelled: "Calibration cancelled.",
    calibLoaded: "Calibration loaded.",
    calibHoldStill: "Hold still.",
    calibNotEnough: "Not enough data collected.",
    calibCounter: "Calibration",
    calibRetrying: "⚠ Retrying…",
    calibNext: "Next.",
    calibQualGood: "Good 👍",
    calibQualFair: "Fair",
    calibQualRetry: "Retry",
    calibQualLabel: "Quality",
    calibErrHigh: "⚠ High noise — hold still",
    calibErrPfx: "Error: ~",
    evalDesc:
      "Targets will appear one by one. Look at each — measurement is taken when dwell fills.",
    evalLookTarget: "Look at the target…",
    evalCounter: "Test",
    repTitle: "📊 Accuracy Report",
    repBack: "Back to App",
    repRecal: "🔄 Recalibrate",
    repAvgErr: "Avg. Error (px)",
    repStdDev: "Std. Deviation (px)",
    repP90: "90th Percentile",
    repFPS: "FPS",
    repLatency: "Latency (ms)",
    repErrMap: "GAZE ERROR MAP",
    repPilot: "📋 PILOT MEASUREMENTS",
    repPass: "Pass ✅",
    repFail: "Low",
    repLow: "Low",
    repOk: "≥20 OK",
    repHighLat: "⚠ High",
    repOkLat: "✅ ≤200ms",
    evalStart: "Accuracy test starting.",
    evalCancelled: "Test cancelled.",
    evalCalibrateFirst: "Please calibrate first.",
    kbLang: "en-US",
    visionScan: "Scan & Describe",
    visionAnalyzing: "AI is analyzing the image…",
    visionDone: "Analysis complete",
    visionError: "Could not analyze image.",
    visionWaiting: "Starting camera…",
    visionReady: "Ready — Look at the scan button",
    visionRepeat: "🔊 Repeat",
    visionCamSwitch: "🔄 Camera",
    visionScanningAudio: "Analyzing image, please wait.",
    apiKeyLabel: "🔑 API Key for AI Vision (optional)",
    apiKeySave: "Save",
    apiKeySaved: "✅ API key saved",
    apiKeyMissing:
      "⚠ API key required for image analysis. Enter it on the start screen.",
    ocrScan: "Read Text",
    ocrAnalyzing: "Reading text…",
    ocrDone: "Text read",
    ocrError: "Could not read text.",
    ocrHint: "Hold camera over text — scans automatically in 3 seconds",
    ocrHintShort: "Hold camera over text…",
    ocrNoText: "No text found in image.",
    ocrModeLabel: "Read Text",
    ocrDescribeLabel: "Describe Scene",
    ocrCountingDown: "Scanning…",
    ocrReady: "Ready — hold camera over text",
    sosMsg: "PANIC — Location will be sent to caregiver",
    sosSending: "📡 Sending emergency notification…",
    sosSent: "✅ Your caregiver has been notified",
    ...
    howClose: "✕ Close",
    howDone: "✓ Got it — Start!",
    how: [
      {
        t: "Choose your input mode",
        d: "On the start screen, tap <b>Start Calibration</b> for eye gaze, or <b>Direct Entry</b> to skip to touch mode. If you have a saved calibration, use <b>Use Saved Calibration</b> to continue.",
        tag: "👁 Eye · ☝️ Touch · 💾 Saved",
        c: "blue",
      },
      {
        t: "Calibrate (Eye Gaze only)",
        d: "17 dots appear one by one. Look steadily at each until the ring fills. Takes ~45 seconds. Calibration data is saved on your device.",
        tag: "🎯 ~45 seconds · 17 points",
        c: "",
      },
      {
        t: "Dwell to select",
        d: "Look at any button and hold your gaze. A yellow bar fills — when full the item is selected. Dwell duration is adjustable in Accessibility settings (default 1.2s).",
        tag: "⏱ Gaze + hold = select",
        c: "",
      },
      {
        t: "Single blink = quick select",
        d: "Enable <b>Single Blink Select</b> in Accessibility. With 8%+ dwell on an item, a single blink instantly selects it.",
        tag: "😉 Blink = select (optional)",
        c: "",
      },
      {
        t: "Double blink = go back",
        d: "Blink twice within 480ms to close the current panel and return. Works everywhere — no settings needed.",
        tag: "😉😉 Double blink = back",
        c: "",
      },
      {
        t: "Iris scroll inside panels",
        d: "With a panel open, move your gaze to the <b>top or bottom edge</b> to scroll. The deeper into the edge zone, the faster it scrolls. Works in Phrase Board, Accessibility and Smart Home panels.",
        tag: "↕ Top/bottom edge = scroll",
        c: "green",
      },
      {
        t: "Phrase Board",
        d: "Dwell on a phrase card to speak it aloud. Dwell on the <b>+</b> button to add your own phrases with a custom emoji.",
        tag: "💬 Gaze → dwell → speaks",
        c: "blue",
      },
      {
        t: "Keyboard",
        d: "Dwell on each key to type. Dwell on word suggestions at the top to autocomplete. Press <b>🔊</b> to read aloud, <b>🎤</b> for voice dictation.",
        tag: "⌨️ Dwell-type · suggestions · TTS",
        c: "blue",
      },
      {
        t: "What's Around Me?",
        d: "Point your camera at your surroundings — AI describes what it sees aloud. With an API key: full visual analysis. Without: OCR text-reading mode.",
        tag: "👁 Scan → AI describes",
        c: "",
      },
      {
        t: "Quick Message",
        d: 'Call saved contacts or send preset messages. Dwell on 📞 or 💬 to act. Customize contacts via "Edit Contacts".',
        tag: "📲 Call · Message",
        c: "",
      },
      {
        t: "Smart Home",
        d: "Turn devices on/off (lights, blinds, thermostat, etc.) by dwelling on their card. Fully functional in demo mode; real devices require MQTT or REST API.",
        tag: "🏠 Dwell = toggle device",
        c: "",
      },
      {
        t: "Panic Button",
        d: "Dwell on the red button in the top-right of the main menu. An emergency alert with your location is sent to your caregiver.",
        tag: "🆘 Long gaze = emergency alert",
        c: "",
      },
      {
        t: "Tips for best accuracy",
        d: "• Sit 40–55 cm from screen · • Good face lighting · • Keep head still · • Recalibrate when changing device · • Use Accessibility → Accuracy Test to check your error",
        tag: "💡 Distance · Light · Stillness",
        c: "",
      },
    ],
  },
...
function t(k) {
  return (I18N[appLang] || I18N.tr)[k] || I18N.tr[k] || k;
}
...
function applyI18n() {
  ...
  if (el("useSavedBtn") && el("useSavedBtn").style.display !== "none")
    el("useSavedBtn").textContent = t("btnSaved");
  // Main menu grid labels
  const btnKeys = {
    phraseBtn: "btnPhrase",
    keyboardBtn: "btnKeyboard",
    visionBtn: "btnVision",
    quickMsgBtn: "btnQuickMsg",
    a11yBtn: "btnA11y",
    recalibBtn: "btnCalib",
  };
  Object.entries(btnKeys).forEach(([id, k]) => {
    const b = el(id);
    if (!b) return;
    const lbl = b.querySelector(".bsm-label");
    if (lbl) lbl.textContent = t(k);
  });
  // Panic label
  const pl = el("panicLabel");
  if (pl) pl.textContent = t("btnPanic");
  // Main header
  const mhs = el("mainMenuSubLabel");
  if (mhs) mhs.textContent = t("menuLabel");
  const mhh = el("mainMenuSubHint");
  if (mhh) mhh.textContent = t("menuHint");
  // Sliders
  const smL = el("smLabel");
  if (smL) smL.textContent = t("smoothing");
  const dwL = el("dwLabel");
  if (dwL) dwL.textContent = t("dwell");
  // Back button
  const gpb = el("globalPanelBack");
  if (gpb) {
    const btnTxt = el("backBtnText");
    if (btnTxt) btnTxt.textContent = t("backBtn");
    const hint = gpb.querySelector(".pb-hint");
    if (hint) hint.textContent = t("backHint");
  }
  // Location widget
  const locT = el("locTitle");
  if (locT) locT.textContent = t("locTitle");
  // Calib / Eval UI
  const cbb = el("calibBackBtn");
  if (cbb) cbb.textContent = "← " + (appLang === "tr" ? "İptal" : "Cancel");
  const ebb = el("evalBackBtn");
  if (ebb) ebb.textContent = "← " + (appLang === "tr" ? "Geri" : "Back");
  const ql = el("qualityLabel");
  if (ql) ql.textContent = t("calibQualLabel");
  const ed = el("evalDesc");
  if (ed) ed.textContent = t("evalDesc");
  const rt = el("repTitle");
  if (rt) rt.textContent = t("repTitle");
  const rd = el("repDoneBtn");
  if (rd) rd.textContent = t("repBack");
  const rr = el("repRecalBtn");
  if (rr) rr.textContent = t("repRecal");
  // A11y close + advanced tools
  const acb = el("a11yCloseBtn");
  if (acb) acb.textContent = t("a11yClose");
  if (el("a11yTitle")) el("a11yTitle").textContent = t("a11yTitle");
  if (el("a11yInputTitle"))
    el("a11yInputTitle").textContent = t("a11yInputTitle");
  if (el("a11yThemeTitle"))
    el("a11yThemeTitle").textContent = t("a11yThemeTitle");
  if (el("a11yBlinkTitle"))
    el("a11yBlinkTitle").textContent = t("a11yBlinkTitle");
  // Mode cards
  if (el("modeEyeLabel")) el("modeEyeLabel").textContent = t("modeEyeLabel");
  if (el("modeEyeSub")) el("modeEyeSub").textContent = t("modeEyeSub");
  if (el("modeFingerLabel"))
    el("modeFingerLabel").textContent = t("modeFingerLabel");
  ...
  if (el("modeDwellLabel"))
    el("modeDwellLabel").textContent = t("modeDwellLabel");
  ...
  // Blink cards
  if (el("irisScrollLabel"))
    el("irisScrollLabel").textContent = t("irisScrollLabel");
  ...
  if (el("blinkSelectTitle"))
    el("blinkSelectTitle").textContent = t("blinkSelectTitle");
  if (el("blinkSensTitle"))
    el("blinkSensTitle").textContent = t("blinkSensTitle");
  if (el("wakeWordTitle")) el("wakeWordTitle").textContent = t("wakeWordTitle");
  // Sliders
  if (el("kbSensLabel"))
    el("kbSensLabel").innerHTML =
      t("kbSensLabelStr") +
      '<b id="kbSensVal">' +
      el("kbSensVal")?.textContent +
      "</b>";
  if (el("a11yDwellLabel"))
    el("a11yDwellLabel").innerHTML =
      t("a11yDwellLabelStr") +
      '<b id="a11yDwellVal">' +
      el("a11yDwellVal")?.textContent +
      "</b> s";
  if (el("a11yAlphaLabel"))
    el("a11yAlphaLabel").innerHTML =
      t("a11yAlphaLabelStr") +
      '<b id="a11yAlphaVal">' +
      el("a11yAlphaVal")?.textContent +
      "</b>";
  // Advanced tools
  const att = el("advToolsTitle");
  if (att) att.textContent = t("advToolsTitle");
  ...
  if (el("blinkSelectLabel"))
    el("blinkSelectLabel").textContent = blinkSelectEnabled
      ? t("blinkOn")
      : t("blinkOff");
  if (el("wakeWordLabel"))
    el("wakeWordLabel").textContent = wakeWordActive
      ? t("wakeOn")
      : t("wakeOff");
  // Quick msg panel
  if ($("quickMsgPanel") && $("quickMsgPanel").style.display === "flex")
    applyQmI18n();
  ...
  // Keyboard
  if (
    typeof renderKB === "function" &&
    el("kbPanel") &&
    el("kbPanel").style.display === "flex"
  )
    renderKB();
  // Vision panel
  const vsL = el("visionScanLabel");
  if (vsL) vsL.textContent = t("visionScan");
  const vsC = el("visionCamSwitch");
  if (vsC) vsC.textContent = t("visionCamSwitch");
  const vrB = el("visionRepeatBtn");
  if (vrB) vrB.textContent = t("visionRepeat");
  // Lang button states
  document
    .querySelectorAll(".lang-btn")
    .forEach((b) => b.classList.toggle("active", b.dataset.lang === appLang));
}
...
function rebuildHowPanel() {
  ...
  if (hdr) {
    hdr.querySelector("h2").textContent = t("howTitle");
    const cl = hdr.querySelector("button");
    if (cl) cl.textContent = t("howClose");
  }
  // Rebuild steps
  ...
  existing.forEach((s, i) => {
    if (!steps[i]) return;
    const st = steps[i];
    const title = s.querySelector(".how-title");
    if (title) title.textContent = st.t;
    const desc = s.querySelector(".how-desc");
    if (desc) desc.innerHTML = st.d;
    const tag = s.querySelector(".how-tag");
    if (tag) {
...
// GLOBALS
// ══════════════════════════════════════════════════════
let ALPHA = parseFloat(localStorage.getItem("es_alpha")) || 0.05;
let DWELL_MS = 1200;
...
let blinkSelectEnabled = JSON.parse(
  localStorage.getItem("es_blinkSel") || "true",
);
...
let earHistory = [],
  earBuf = 2; // 2 frame — blink'i ezmez
let blinkState = "open";
let blinkCloseTime = 0,
  lastBlinkTime = 0,
  blinkCount = 0;
let currentEAR = 1.0;
let blinkSensLevel = 1;
const BLINK_SENS = [
  { close: 0.14, open: 0.2, label: "Low" },
...
const OL_MAX = 20; // max buffer size
...
const calibDotEl = $("calibDot"),
  calibRingEl = $("calibRing");
const calibMsg = $("calibMsg"),
  calibCounter = $("calibCounter");
const qualityFill = $("qualityFill"),
  qualityText = $("qualityText");
const evalScreen = $("evalScreen"),
  evalDotEl = $("evalDot"),
  evalRingEl = $("evalRing");
const evalMsg = $("evalMsg"),
  evalCounter = $("evalCounter");
const reportScreen = $("reportScreen"),
  mainUI = $("mainUI");
const statusBar = $("statusBar"),
  irisQ = $("irisQ");
const phraseBoard = $("phraseBoard"),
  output = $("output"),
  outputText = $("outputText");
const lightWarn = $("lightWarn"),
  headWarn = $("headWarn");
...
function speak(txt) {
  ...
  // Android Native TTS — önce bunu dene
  if (window.AndroidTTS && typeof window.AndroidTTS.speak === "function") {
    try {
      window.AndroidTTS.speak(txt.trim());
      return;
    } catch (e) {}
  }
...
function kbHitPad() {
  return kbSensitivity === 3 ? 10 : kbSensitivity === 1 ? 0 : 5;
}
...
function setInputMode(m) {
  ...
  ["Eye", "Finger", "Both", "Dwell"].forEach((n) => {
    const el = $("mode" + n);
  ...
  const btn = $("mode" + map[m]);
  if (btn) btn.classList.add("active");
  if (m === "finger" || m === "both") enableTouchInput();
  else disableTouchInput();

  // Dokunmatik modda: dot gizle, geri butonu göster
  // Göz modunda: dot göster, blink ile geri/seçim
  const isEyeMode = m === "eye" || m === "both" || m === "dwellonly";
  if (dot) dot.style.display = isEyeMode ? "block" : "none";
  if (dwellRing) dwellRing.style.display = isEyeMode ? "block" : "none";

  // Dokunmatik modda fiziksel geri butonu göster
  const backBtn = document.getElementById("globalPanelBack");
  if (backBtn) {
    if (m === "finger") {
      backBtn.style.display = "flex";
    } else {
      // Göz modunda sayfa stack'e göre göster
      updateGazeBackVisibility();
    }
  }

  // Göz modunda blink nav/select aktif, dokunmatik modda iptal (conflict önle)
  if (m === "finger") {
    blinkNavEnabled = false;
    blinkSelectEnabled = false;
  } else if (m === "eye") {
    blinkNavEnabled = JSON.parse(localStorage.getItem("es_blinkNav") || "true");
    blinkSelectEnabled = JSON.parse(
      localStorage.getItem("es_blinkSel") || "false",
    );
  }
}
...
function enableTouchInput() {
  ...
  document.addEventListener("touchstart", onTouchGaze, {
    passive: false,
  });
...
function onTouchEnd() {
  if (inputMode === "finger") resetAllDwells();
}
function resetAllDwells() {
  ...
  iotDwells.forEach((id) => {
    id.elapsed = 0;
    id.el.classList.remove("gazing");
    id.overlay.style.width = "0%";
  });
}
...
// ══════════════════════════════════════════════════════
/**
 * Gaze Snapping Engine — Apple VisionOS Eye-Gaze Interaction Model
 * 100px içindeki butonlara quadratic ease-in ile çekim uygular.
 * Max snap force: %70
 */
function findSnapTarget(x, y) {
  ...
  const sels = [
    "#mainUI .btn-sm",
    "#phraseBoard .phrase-btn",
    "#kbPanel .kb-key",
    "#a11yPanel .a11y-card",
    "#a11yPanel .mode-card",
    "#iotPanel .iot-card",
    "#quickMsgPanel .qm-contact",
    "#quickMsgPanel .qm-msg",
    ".adv-tool-btn",
    ".panel-back-btn",
  ...
  for (const el of sels) {
    ...
    if (d < SNAP_R && d < bd) {
      bd = d;
      const t = 1 - d / SNAP_R;
      best = { cx, cy, strength: t * t * MAX_SNAP };
    }
  }
  return best;
}
...
function dispatchGaze(gx, gy, dt) {
  ...
  if (phraseBoard.style.display === "flex")
    updatePhraseDwells(gx, gy, Math.min(dt, 80));
  if ($("kbPanel").style.display === "flex")
    updateKbDwells(gx, gy, Math.min(dt, 80));
  if ($("iotPanel").style.display === "flex")
    updateIotDwells(gx, gy, Math.min(dt, 80));
  if (mainUI.style.display === "flex")
    updateMainMenuDwells(gx, gy, Math.min(dt, 80));
  if (mainUI.style.display === "flex")
    updatePanicDwell(gx, gy, Math.min(dt, 80));
  updateGazeBack(gx, gy, Math.min(dt, 80));
  updateGlobalPanelBack(gx, gy, Math.min(dt, 80));
  if ($("visionPanel").style.display === "flex")
    updateVisionDwells(gx, gy, Math.min(dt, 80));
  if ($("quickMsgPanel").style.display === "flex")
    updateQmDwells(gx, gy, Math.min(dt, 80));
}
...
function updateMainMenuDwells(gx, gy, dt) {
  ...
  mainDwells.forEach((md) => {
    ...
    if (inside) {
      md.elapsed += dt;
      md.el.classList.add("gazing");
    } else {
      md.elapsed = Math.max(0, md.elapsed - dt * 2);
      if (!md.elapsed) md.el.classList.remove("gazing");
    }
    const pct = Math.min(1, md.elapsed / (DWELL_MS * 1.1));
    md.overlay.style.width = pct * 100 + "%";
    if (pct >= 1 && !md.fired) {
      md.fired = true;
      md.el.classList.remove("gazing");
      md.overlay.style.width = "0%";
      md.elapsed = 0;
      md.fired = false;
      // Aksiyonu tetikle
...
function updateGlobalPanelBack(gx, gy, dt) {
  ...
  const inside =
    ...
    gy <= r.bottom + 6;
  if (inside) {
    globalBackElapsed += dt;
    globalPanelBackEl.classList.add("gazing");
  } else {
    globalBackElapsed = Math.max(0, globalBackElapsed - dt * 2);
    globalPanelBackEl.classList.remove("gazing");
  }
  const pct = Math.min(1, globalBackElapsed / 1400);
  globalPanelBackDwellEl.style.width = pct * 100 + "%";
  if (pct >= 1) {
    globalBackElapsed = 0;
    globalPanelBackDwellEl.style.width = "0%";
    gazeBack();
  }
}
...
function updateGazeBack(gx, gy, dt) {
  ...
  if (inside) {
    gazeBackElapsed += dt;
    gazeBackBtn.classList.add("gazing");
  } else {
    gazeBackElapsed = Math.max(0, gazeBackElapsed - dt * 2);
...
function updateGazeBackVisibility() {
  ...
  gazeBackElapsed = 0;
  $("gazeBackDwell").style.width = "0%";
  gazeBackBtn.classList.remove("gazing");
  // Global panel back button — klavye açıkken GİZLE, diğer panellerde göster
  const gpb = document.getElementById("globalPanelBack");
  const kbOpen = $("kbPanel") && $("kbPanel").style.display === "flex";
  if (gpb) {
    gpb.style.display = pageStack.length && !kbOpen ? "flex" : "none";
    globalBackElapsed = 0;
...
function setTheme(t) {
  ...
  currentTheme = t;
  if (t !== "n") document.body.classList.add(t);
...
function openA11y() {
  ...
  updateBlinkUI();
  const alphaSl = $("a11yAlphaSl");
  if (alphaSl) {
    alphaSl.value = Math.round(ALPHA * 100);
    $("a11yAlphaVal").textContent = ALPHA.toFixed(2);
  }
  const dwellSl = $("a11yDwellSl");
  if (dwellSl) {
    dwellSl.value = Math.round(DWELL_MS / 100);
    $("a11yDwellVal").textContent = (DWELL_MS / 1000).toFixed(1);
  }
}
function closeA11y() {
...
let qmContacts =
  JSON.parse(localStorage.getItem(QM_STORAGE_KEY) || "null") ||
  QM_DEFAULT_CONTACTS;
...
function applyQmI18n() {
  if (appLang === "en") {
    ...
    if (list)
      list.querySelectorAll(".qm-msg").forEach((el, i) => {
        if (msgs[i]) {
          el.querySelector(".qmm-icon").textContent = msgs[i].i;
          el.querySelector(".qmm-text").textContent = msgs[i].t;
        }
      });
    // Contact roles
...
function qmSms(idx) {
  ...
  const msg =
    appLang === "tr"
      ? "EyeSense: Yardıma ihtiyacım var."
      : "EyeSense: I need help.";
...
async function qmSendMsg(text, contactIdx = 0) {
  ...
  const contact =
    typeof qmContacts !== "undefined" && qmContacts[contactIdx]
  ...
  try {
    ...
    const successMsg =
      appLang === "tr" ? "✅ Bildirim Gönderildi" : "✅ Notification Sent";
...
function openQmEdit() {
  const name0 = prompt(
    appLang === "tr" ? "Refakatçi adı:" : "Caregiver name:",
    qmContacts[0].name,
  );
  if (!name0) return;
  const phone0 = prompt(
    appLang === "tr" ? "Telefon (ör: +905..):" : "Phone:",
    qmContacts[0].phone || "",
  );
...
function updateQmDwells(gx, gy, dt) {
  ...
  qmMsgDwells.forEach((d) => {
    ...
    if (inside) {
      d.elapsed += dt;
      d.el.classList.add("gazing");
    } else {
      d.elapsed = Math.max(0, d.elapsed - dt * 2);
...
function toggleWakeWord() {
  ...
  if (lbl)
    lbl.textContent = wakeWordActive
      ? appLang === "tr"
        ? "Açık ✓"
        : "On ✓"
      : appLang === "tr"
  ...
  speak(
    wakeWordActive
      ? appLang === "tr"
        ? '"EyeSense yardım et" dinleniyor'
        : 'Listening for "EyeSense help"'
      : appLang === "tr"
        ? "Uyandırma komutu kapatıldı"
        : "Wake word disabled",
  );
}
  ...
  const risks = [
    {
      ...
      status:
        lightLevel === "normal" ? "ok" : lightLevel === "low" ? "warn" : "bad",
      value:
        lightLevel === "normal"
          ? `Normal (luma:${lastLuma.toFixed(0)})`
          : lightLevel === "low"
            ? `Low (luma:${lastLuma.toFixed(0)})`
            : `Insufficient (luma:${lastLuma.toFixed(0)})`,
      detail:
        "System should be tested in bright, medium and low light. Iris detection degrades in low light. Luma>60 = normal, 32–60 = low, <32 = insufficient.",
      mitigation:
        "Adaptive gamma compensation (γ = log(0.5)/log(luma/255)) active. Try Night Mode theme.",
    },
    {
      ...
      detail:
        "720p or higher camera recommended. Lower resolution reduces iris detection accuracy.",
      ...
      value:
        headMoveCount < 5
          ...
          : headMoveCount < 12
            ...
            : "Excessive",
      detail:
        "Large head movements degrade gaze prediction. Head pose compensation is active (±15°).",
    ...
    },
    {
      ...
      detail:
        "Target: ≤200ms total. Camera(20ms) + FaceMesh(30ms) + Gaze(10ms) + UI(15ms) ≈ 75ms ideal.",
      mitigation:
        "High latency → lower ALPHA smoothing, set kbSensitivity to normal.",
    },
    {
      label: "🌐 Browser Compatibility",
      status:
        window.chrome || navigator.userAgent.includes("Edg") ? "ok" : "warn",
      value: window.chrome
        ? "Chrome ✓"
        : navigator.userAgent.includes("Edg")
          ...
          : navigator.userAgent.includes("Firefox")
            ...
            : "Unknown",
      detail:
        "WebRTC + WebGL work best with Chrome/Edge. MediaPipe performance may drop on Firefox.",
    ...
    },
    {
      ...
      detail:
        "Video frames are never stored. WebRTC camera access — only a temporary memory buffer is used.",
      mitigation:
        "No frames are sent to any server. Only calibration model weights are stored in localStorage.",
    },
  ];
  const colorMap = { ok: "#22dd88", warn: "#ffaa00", bad: "#ff5555" };
  $("diagContent").innerHTML = risks
    .map(
      (r) => `
...
function processBlink(lm, ts) {
  const re = earCalc(lm, RET, REB, RO, RN),
    le = earCalc(lm, LET, LEB, LO, LN);
  currentEAR = (re + le) / 2;
  ...
  // ── Klavye tarama modunda: lsProcessEAR devralır
  if (lsActive && $("kbPanel") && $("kbPanel").style.display === "flex") {
    lsProcessEAR(smooth, ts);
    return;
  }

  if (blinkState === "open" && smooth < s.close) {
    blinkState = "closed";
    blinkCloseTime = ts;
  ...
  } else if (blinkState === "closed" && ts - blinkCloseTime > 1500) {
    blinkState = "open";
  }
}
...
function showBlinkFlash(msg) {
  blinkFlash.textContent = msg;
  blinkFlash.style.display = "block";
  blinkFlash.style.opacity = "1";
  clearTimeout(blinkFlash._t);
  blinkFlash._t = setTimeout(() => {
    blinkFlash.style.opacity = "0";
    setTimeout(() => (blinkFlash.style.display = "none"), 200);
  }, 700);
}
...
function triggerBlinkSelect() {
  ...
  if ($("kbPanel").style.display === "flex") {
    ...
    kbSuggDwells.forEach((sd) => {
      ...
      if (pct > bestPct && pct > 0.08) {
        bestPct = pct;
        best = { type: "kbsugg", d: sd };
      }
    });
    // [see source for notes]
    kbDwells.forEach((kd) => {
    ...
    if (!best) {
      showBlinkFlash("👁 Look at a key");
      return;
    }
    if (best.type === "kbsugg") {
      kbPickSugg(best.d.word);
      showBlinkFlash("✅ " + best.d.word);
    } else {
      flashKey(best.d.el);
      kbAction(best.d.key);
      best.d.elapsed = 0;
      best.d.el.classList.remove("gazing", "blink-ready");
      best.d.overlay.style.width = "0%";
      showBlinkFlash(
        "✅ " +
          (best.d.key === "⎵"
            ? "SPACE"
  ...
  if (phraseBoard.style.display === "flex") {
    phraseDwells.forEach((pd) => {
      ...
      if (pct > bestPct && pct > 0.08) {
        bestPct = pct;
        best = { type: "phrase", d: pd };
      }
    });
    if (!best) {
      showBlinkFlash("👁 Look at a phrase");
      return;
    }
    outputText.textContent = best.d.phrase.i + " " + best.d.phrase.t;
    output.style.display = "flex";
    speak(best.d.phrase.t);
  ...
  if ($("iotPanel").style.display === "flex") {
    ...
    if (!best) {
      showBlinkFlash("👁 Look at a device");
      return;
    }
  ...
  if (mainUI.style.display === "flex") {
    ...
    if (!best) {
      showBlinkFlash("👁 Look at a button");
      return;
    }
...
function toggleBlinkKb() {
  ...
  // v15: kbBlinkToggle butonu kaldırıldı — tarama modu kullanılıyor
...
function toggleBlinkSelect() {
  ...
  speak(
    blinkSelectEnabled
      ? "Blink select on. Single blink to select."
      : "Blink select off.",
  );
}
...
function updateBlinkUI() {
  const c = $("blinkNavCard");
  if (c) c.classList.toggle("active", true); // always shown as active
  const s = $("blinkSelectCard");
  if (s) s.classList.toggle("active", blinkSelectEnabled);
  const sl = $("blinkSelectLabel");
  if (sl) sl.textContent = blinkSelectEnabled ? "On ✓" : "Off";
  const hint = $("blinkHint");
  if (hint) hint.style.display = blinkSelectEnabled ? "block" : "none";
}

// ══════════════════════════════════════════════════════
// FEATURE EXTRACTION
// ══════════════════════════════════════════════════════
const RI = [469, 470, 471, 472],
  LI = [474, 475, 476, 477];
const RO = 33,
  RN = 133,
  RT = 159,
...
function getFeatures(lm) {
  const re = earCalc(lm, RET, REB, RO, RN),
    le = earCalc(lm, LET, LEB, LO, LN);
  if (re < 0.04 || le < 0.04) return null;
  const nose = lm[1];
  if (prevNoseX !== null) {
    const dx = Math.abs(nose.x - prevNoseX),
      dy = Math.abs(nose.y - prevNoseY);
    headMoveCount =
      dx > 0.012 || dy > 0.012
        ? Math.min(headMoveCount + 1, 20)
        : Math.max(0, headMoveCount - 1);
    headWarn.style.display = headMoveCount > 7 ? "block" : "none";
  }
  prevNoseX = nose.x;
  prevNoseY = nose.y;
  const rIris = avg(lm, RI),
    lIris = avg(lm, LI);
  ...
  function off(oi, ni, ti, bi, iris) {
    const o = lm[oi],
      ...
      t = lm[ti],
      b = lm[bi];
    const x0 = Math.min(o.x, n.x),
      x1 = Math.max(o.x, n.x);
    const y0 = Math.min(t.y, b.y),
      y1 = Math.max(t.y, b.y);
    const w = x1 - x0,
      h = y1 - y0;
  ...
  const rO = off(RO, RN, RT, RB, rIris),
    lO = off(LO, LN, LT, LB, lIris);
...
function getHeadPose(lm) {
  ...
  const roll = Math.atan2(
    leftEyeOut.y - rightEyeOut.y,
    leftEyeOut.x - rightEyeOut.x,
  );
...
function polyExpand(f) {
  ...
  const cross = [];
  for (let i = 0; i < 4; i++)
    for (let j = i; j < 4; j++) cross.push(base[i] * base[j]);
  return [...base, ...cross];
}
...
function ridgeFit(X, y, lam = 0.005) {
  ...
  const XtX = Array.from({ length: F1 }, (_, i) =>
    Array.from(
      { length: F1 },
      (_, j) => Xb.reduce((s, r) => s + r[i] * r[j], 0) + (i === j ? lam : 0),
    ),
  );
  const Xty = Array.from({ length: F1 }, (_, i) =>
    Xb.reduce((s, r, n) => s + r[i] * y[n], 0),
  );
  const A = XtX.map((r, i) => [...r, Xty[i]]);
  for (let c = 0; c < F1; c++) {
    let piv = c;
    for (let r = c + 1; r < F1; r++)
    ...
    for (let r = 0; r < F1; r++) {
      if (r === c) continue;
      const f = A[r][c];
      for (let k = c; k <= F1; k++) A[r][k] -= f * A[c][k];
    }
  }
  return A.map((r) => r[F1]);
}
function predict(w, f) {
  return [1, ...f].reduce((s, v, i) => s + v * w[i], 0);
}
...
function saveCalibration() {
  try {
    localStorage.setItem("es_mx", JSON.stringify(modelX));
    localStorage.setItem("es_my", JSON.stringify(modelY));
    localStorage.setItem("es_date", new Date().toLocaleString("tr-TR"));
  } catch (e) {}
}
function loadCalibration() {
  try {
    const mx = localStorage.getItem("es_mx"),
      my = localStorage.getItem("es_my");
    if (mx && my) {
      modelX = JSON.parse(mx);
      modelY = JSON.parse(my);
      return true;
    }
  } catch (e) {}
  return false;
...
function olUpdateModel() {
  ...
  if (calibData && calibData.length >= 8) {
    calibData.forEach((d) => {
      combined.push({ f: polyExpand(d.f), sx: d.sx, sy: d.sy });
      combined.push({ f: polyExpand(d.f), sx: d.sx, sy: d.sy });
    });
  }
  ...
  const newMX = ridgeFit(
    Xpoly,
    combined.map((d) => d.sx),
    0.003,
  );
  const newMY = ridgeFit(
    Xpoly,
    combined.map((d) => d.sy),
    0.003,
  );
  // [see source for notes]
  modelX = modelX.map((w, i) => w * 0.95 + newMX[i] * 0.05);
  modelY = modelY.map((w, i) => w * 0.95 + newMY[i] * 0.05);
  // [see source for notes]
...
// ══════════════════════════════════════════════════════
class DwellTracker {
  constructor(tx, ty, r, dur, onP, onC) {
    this.tx = tx;
    this.ty = ty;
    this.r = r;
    this.dur = dur;
  ...
  update(gx, gy, ts) {
    if (this.done) return;
    const inside =
      Math.sqrt((gx - this.tx) ** 2 + (gy - this.ty) ** 2) < this.r;
    if (inside) {
      if (this.lt !== null) this.el += ts - this.lt;
      this.lt = ts;
    } else {
      this.el = 0;
      this.lt = null;
    }
    const pct = Math.min(1, this.el / this.dur);
    this.onP(pct);
    if (pct >= 1) {
      this.done = true;
      this.onC();
...
let calibData = [],
  ...
  calibBuf = [];
let calibRingBar = null,
  evalRingBar = null;
let calibPhase = 1; // 1 or 2
let calibAllPts = []; // assembled at start
let calibPrevX = null,
  calibPrevY = null; // for dot slide animation
...
function calibMeanErrorCm() {
  ...
  const errs = calibData.map((d) => {
    ...
    const px = predict(modelX, fp),
      py = predict(modelY, fp);
...
function adaptiveRingMs() {
  ...
  const avg =
    calibRecentNoise.reduce((a, b) => a + b, 0) / calibRecentNoise.length;
  // noisy user → slower fill gives more time to stabilise
  const frac = Math.min(1, avg / CALIB_NOISE_THRESH);
  return Math.round(
    CALIB_RING_MIN_MS + frac * (CALIB_RING_MAX_MS - CALIB_RING_MIN_MS),
  );
}
...
function startCalibration() {
  ...
  // Kalibrasyon sırasında göz takip dot'u mavi göster
  dot.style.display = "block";
  dot.style.background = "radial-gradient(circle at 35% 35%,#88ccff,#1144cc)";
  dot.style.boxShadow =
    "0 0 0 3px rgba(68,136,255,0.3),0 0 14px rgba(68,136,255,0.6)";
  mainUI.style.display = "none";
  lightWarn.style.display = "none";
  headWarn.style.display = "none";
  calibRingBar = makeRing(calibRingEl, 100, CR);
  calibRingEl.style.display = "block";
  speak(t("calibStart"));
  // Canlı kamera önizlemeyi başlat
  startCalibCamPreview();
...
function cancelCalibration() {
  ...
  calibIdx = 9999;
  stopCalibCamPreview();
  dot.style.background = "radial-gradient(circle at 35% 35%,#ffee88,#cc1111)";
  dot.style.boxShadow =
    "0 0 0 3px rgba(255,0,0,0.18),0 0 14px rgba(255,80,0,0.45)";
  calibDotEl.style.display = "none";
  calibRingEl.style.display = "none";
  calibMsg.style.display = "none";
  calibCounter.style.display = "none";
...
function cancelEvaluation() {
  evalActive = false;
  evalIdx = 9999;
  evalDotEl.style.display = "none";
  evalRingEl.style.display = "none";
  evalMsg.style.display = "none";
  evalCounter.style.display = "none";
...
function animateDotTo(toX, toY, onDone) {
  const fromX = calibPrevX ?? toX,
    fromY = calibPrevY ?? toY;
  const dur = 350,
    t0 = performance.now();
  function step(now) {
...
function collectCalibPt(idx, sx, sy) {
  ...
  const iv = setInterval(() => {
    ...
    if (calibBuf.length >= CALIB_SAMPLES) {
      ...
      /**
       * Robust Outlier Rejection via Trimmed Median Filter
       * En kötü %40 frame atılır, kalan %60'ın medyanı alınır.
       */
      function medianTrimFilter(buf) {
        const n = buf[0].length;
        const trim = Math.floor(buf.length * 0.4);
        const medians = Array.from({ length: n }, (_, fi) => {
          const vals = buf.map((b) => b[fi]).sort((a, b) => a - b);
          return vals[Math.floor(vals.length / 2)];
        });
        const scores = buf.map((f) => {
          let s = 0;
          for (let fi = 0; fi < n; fi++) s += (f[fi] - medians[fi]) ** 2;
          return Math.sqrt(s);
        });
        const sorted = [...scores].sort((a, b) => a - b);
        const thresh = sorted[Math.max(0, sorted.length - 1 - trim)];
        return buf.filter((_, i) => scores[i] <= thresh);
      }
      const filtered = medianTrimFilter(calibBuf);
      const useBuf = filtered.length >= 12 ? filtered : calibBuf;
      ...
      if (meanStd > CALIB_NOISE_THRESH) {
        ...
        if (errMsg) {
          errMsg.textContent = `${t("calibErrHigh")} (σ=${meanStd.toFixed(3)})`;
          errMsg.style.display = "block";
          setTimeout(() => (errMsg.style.display = "none"), 2500);
        }
      ...
      const avgF = useBuf[0].map((_, fi) => {
        const vals = useBuf.map((f) => f[fi]).sort((a, b) => a - b);
        return vals[Math.floor(vals.length / 2)];
      });
      ...
      if (calibPhase === 1 && calibData.length === CALIB_PTS_PHASE1.length) {
        ...
        if (errCm <= CALIB_GOOD_CM) {
          ...
          speak(
            appLang === "tr"
              ? "Harika, kalibrasyon tamamlandı."
              : "Great, calibration complete.",
          );
          setTimeout(() => {
            if (calibActive) endCalibration();
          }, 600);
...
function endCalibration() {
  ...
  calibCounter.style.display = "none";
  $("qualityBar").style.display = "none";
  $("calibErrMsg").style.display = "none";
  hideAllScreens();
  if (trainModel(calibData)) {
    onlineBuffer = [];
    calibData.forEach((d) =>
      onlineBuffer.push({ f: polyExpand(d.f), sx: d.sx, sy: d.sy }),
    ); // Her kalibrasyon buffer sıfırlanır

    // Bias Correction: sistematik offset'i intercept'e ekle
    let bx = 0,
      by = 0;
    calibData.forEach((d) => {
      const fp = polyExpand(d.f);
      bx += d.sx - predict(modelX, fp);
      by += d.sy - predict(modelY, fp);
    });
    bx /= calibData.length;
    by /= calibData.length;
    if (
      Math.abs(bx) < window.innerWidth * 0.3 &&
      Math.abs(by) < window.innerHeight * 0.3
    ) {
      modelX[0] += bx;
      modelY[0] += by;
    }
    ...
    calibData.forEach((d) => {
      ...
      const errPx = Math.hypot(
        predict(modelX, fp) - d.sx,
        predict(modelY, fp) - d.sy,
      );
      totalErr += errPx;
    });
    const avgErrPx = totalErr / calibData.length;
    const score = Math.max(0, Math.min(100, Math.round(100 - avgErrPx / 1.5)));
    const scoreColor =
      score >= 80 ? "#22dd88" : score >= 60 ? "#ffe033" : "#ff6666";
    const scoreEmoji = score >= 80 ? "🎯" : score >= 60 ? "⚠️" : "❌";
    showCalibScore(score, scoreColor, scoreEmoji, Math.round(avgErrPx));
    speak(t("calibDone"));
  } else {
    speak(t("calibNotEnough"));
    showStartScreen();
  }
}

function showCalibScore(score, color, emoji, errPx) {
  hideAllScreens();
  let d = document.getElementById("calibScoreScreen");
  if (!d) {
    d = document.createElement("div");
    d.id = "calibScoreScreen";
    d.style.cssText =
      "position:fixed;inset:0;background:#040408;z-index:500;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:18px;padding:32px;";
    document.body.appendChild(d);
  }
  const circ = Math.round(2 * Math.PI * 65);
  const offset = Math.round(circ * (1 - score / 100));
  const msg =
    score >= 80
      ? "Mükemmel! Göz takibi çok doğru."
      : score >= 60
        ? "İyi. Daha iyi için yeniden kalibre edebilirsin."
        : errPx > 80
          ? "Sapma yüksek. Işığı artır ve başını sabit tut."
          : "Ortalama sonuç. Tekrar kalibre etmek skoru artırabilir.";
  d.innerHTML =
    '<div style="font-size:64px;">' +
    emoji +
    "</div>" +
    '<div style="font-family:Syne,sans-serif;font-size:16px;color:rgba(255,255,255,0.45);letter-spacing:.12em;text-transform:uppercase;">Kalibrasyon Tamamlandı</div>' +
    '<div style="position:relative;width:150px;height:150px;">' +
    '<svg width="150" height="150" viewBox="0 0 150 150">' +
    '<circle cx="75" cy="75" r="65" fill="none" stroke="rgba(255,255,255,0.07)" stroke-width="10"/>' +
    '<circle cx="75" cy="75" r="65" fill="none" stroke="' +
    color +
    '" stroke-width="10" stroke-dasharray="' +
    circ +
    '" stroke-dashoffset="' +
    offset +
    '" stroke-linecap="round" transform="rotate(-90 75 75)" style="transition:stroke-dashoffset 1s ease;"/>' +
    "</svg>" +
    '<div style="position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;">' +
    '<div style="font-family:Syne,sans-serif;font-size:42px;font-weight:800;color:' +
    color +
    ';">' +
    score +
    "</div>" +
    '<div style="font-size:12px;color:rgba(255,255,255,0.4);">/100</div>' +
    "</div>" +
    "</div>" +
    '<div style="font-size:13px;color:rgba(255,255,255,0.35);text-align:center;line-height:1.8;">Ortalama sapma: <b style="color:rgba(255,255,255,0.7);">' +
    errPx +
    "px</b><br>" +
    msg +
    "</div>" +
    '<button onclick="document.getElementById(&quot;calibScoreScreen&quot;).style.display=&quot;none&quot;;showMainMode();" style="padding:14px 40px;background:linear-gradient(135deg,#1535a0,#2a5ce0);border:1px solid rgba(68,136,255,0.5);border-radius:16px;color:#fff;font-size:15px;font-family:Syne,sans-serif;font-weight:700;cursor:pointer;">Devam Et &#x2192;</button>';
...
function startEvaluation() {
  ...
  mainUI.style.display = "none";
  dot.style.display = "block";
  evalRingBar = makeRing(evalRingEl, 100, CR);
  evalRingEl.style.display = "none";
  evalDotEl.style.display = "none";
  evalMsg.style.display = "block";
  evalCounter.style.display = "block";
  speak(t("evalStart"));
  setTimeout(() => showEvalPt(0), 1500);
}
function showEvalPt(idx) {
  if (idx >= EVAL_PTS.length) {
    endEvaluation();
    return;
  }
  ...
  evalMsg.textContent = t("evalLookTarget");
  evalCounter.textContent = `${t("evalCounter")}: ${idx + 1}/${EVAL_PTS.length}`;
  setTimeout(() => evalDotEl.classList.add("active"), 400);
  // [see source for notes]
  let gazeSamples = [];
  evalDwellTracker = new DwellTracker(
    px,
    py,
    100,
    1600,
    (pct) => {
      evalRingBar.style.strokeDashoffset = CCIRC * (1 - pct);
    },
    () => {
      // [see source for notes]
      const gx =
        gazeSamples.length > 0
          ? gazeSamples.reduce((s, v) => s + v.x, 0) / gazeSamples.length
          : smX;
      const gy =
        gazeSamples.length > 0
          ? gazeSamples.reduce((s, v) => s + v.y, 0) / gazeSamples.length
          : smY;
      const dx = gx - px,
        dy = gy - py;
...
function showReport() {
  ...
  const dpiNote = localStorage.getItem("es_pxcm")
    ? '<span style="color:#4d4;font-size:10px;">✓ Real DPI</span>'
    : '<span style="color:#fa0;font-size:10px;">⚠ Estimated DPI</span>';
  ...
  const W = 240,
    H = 150;
  const sx = (x) => (x / window.innerWidth) * W,
    sy = (y) => (y / window.innerHeight) * H;
  const dots = evalErrors
    .map((e) => {
...
<circle cx="${sx(e.gx).toFixed(1)}" cy="${sy(e.gy).toFixed(1)}" r="3" fill="${c}" fill-opacity="0.85"/>`;
  ...
  const camMs = 20,
    faceMs = Math.max(15, pipelineLatencyMs - 35),
    gazeMs = 10,
    uiMs = 15,
    totalMs = camMs + faceMs + gazeMs + uiMs;
...
<div style="color:#aaa;font-weight:700;">Total</div><div style="color:${totalMs <= 200 ? "#22dd88" : "#fa0"};font-weight:700;">~${totalMs} ms ${totalMs <= 200 ? "✅" : ""}</div>
    ...
    ${evalErrors
      .map((e, i) => {
        const c = e.err < 80 ? "ok" : e.err < 160 ? "mid" : "bad";
        return `<div class="er"><span>Point ${i + 1}</span><span class="${c}">${e.err.toFixed(0)}px · ~${toCm(e.err)}cm (Δx:${e.dx.toFixed(0)} Δy:${e.dy.toFixed(0)})</span></div>`;
      })
      .join("")}`;

  speak(
    `Test complete. Average ${toCm(avg)} centimetres. Standard deviation ${toCm(sd)} centimetres.`,
  );
}
...
const DEF_PHRASES = [
  ...
  { i: "😣", t: "I am in pain" },
  { i: "🚽", t: "Bathroom" },
  { i: "🌡️", t: "I have a fever" },
  { i: "😴", t: "I want to sleep" },
  { i: "❓", t: "I don't understand" },
  { i: "😊", t: "I am fine" },
  { i: "📞", t: "Please call someone" },
  { i: "🔁", t: "Retry" },
];
const EMOJIS = [
  "💧",
...
function loadPhrases() {
  try {
    const s = localStorage.getItem("es_phrases");
    userPhrases = s ? JSON.parse(s) : [...DEF_PHRASES];
  } catch (e) {
...
function savePhrases() {
  try {
    localStorage.setItem("es_phrases", JSON.stringify(userPhrases));
  } catch (e) {}
}
...
function closePhraseBoard() {
  phraseBoard.style.display = "none";
...
function renderPhrases() {
  ...
  userPhrases.forEach((p, i) => {
    ...
    btn.querySelector(".ph-del").onclick = (e) => {
      e.stopPropagation();
      userPhrases.splice(i, 1);
      savePhrases();
      renderPhrases();
    };
    g.appendChild(btn);
    phraseDwells.push({
      el: btn,
      overlay: btn.querySelector(".dwell-ov"),
      phrase: p,
      elapsed: 0,
      fired: false,
    });
...
function openAddModal() {
  ...
  EMOJIS.forEach((e) => {
    ...
    sp.className = "e-opt" + (e === selEmoji ? " sel" : "");
    sp.textContent = e;
    sp.onclick = () => {
      selEmoji = e;
      row.querySelectorAll(".e-opt").forEach((x) => x.classList.remove("sel"));
...
$("addConfirm").onclick = () => {
  const t = $("phraseInput").value.trim();
  if (!t) return;
  userPhrases.push({ i: selEmoji, t });
  savePhrases();
...
function updatePhraseDwells(gx, gy, dt) {
  phraseDwells.forEach((pd) => {
    ...
    if (inside) {
      pd.elapsed += dt;
      pd.el.classList.add("gazing");
    } else {
      pd.elapsed = Math.max(0, pd.elapsed - dt * 2.5);
      if (!pd.elapsed) pd.el.classList.remove("gazing");
    }
    const pct = Math.min(1, pd.elapsed / DWELL_MS);
    pd.overlay.style.width = pct * 100 + "%";
    if (pct >= 1 && !pd.fired) {
      pd.fired = true;
      outputText.textContent = pd.phrase.i + " " + pd.phrase.t;
      output.style.display = "flex";
      speak(pd.phrase.t);
      // [see source for notes]
      const r = pd.el.getBoundingClientRect();
...
function renderIot() {
  ...
  IOT.forEach((d) => {
    ...
    iotDwells.push({
      el: c,
      dev: d,
      overlay: c.querySelector(".dwell-ov"),
      elapsed: 0,
      fired: false,
    });
  });
...
function updateIotDwells(gx, gy, dt) {
  iotDwells.forEach((id) => {
    ...
    if (inside) {
      id.elapsed += dt;
      id.el.classList.add("gazing");
    } else {
      id.elapsed = Math.max(0, id.elapsed - dt * 2);
      id.el.classList.remove("gazing");
    }
    ...
    if (pct >= 1 && !id.fired) {
      ...
      console.log(
        `[EyeSense IoT] ${id.dev.n} → ${id.dev.s ? "ON" : "OFF"} | MQTT topic: home/${id.dev.id || "device"}/set`,
      );
...
const kbEngine = {
  ...
  contextVocab: {
    tv: {
      tr: ["kanal", "ses", "kapat", "aç", "yükselt"],
      en: ["channel", "volume", "off", "on", "louder"],
    },
    chair: {
      tr: ["otur", "kalk", "taşı", "yakın"],
      en: ["sit", "stand", "move", "closer"],
    },
    bed: {
      tr: ["uyu", "kalk", "yardım", "minder"],
      en: ["sleep", "get up", "help", "pillow"],
    },
    table: {
      tr: ["yemek", "koy", "temizle", "kaldır"],
      en: ["food", "place", "clean", "remove"],
    },
    cup: {
      tr: ["su", "çay", "doldur", "boş"],
      en: ["water", "tea", "fill", "empty"],
    },
    book: {
      tr: ["oku", "ver", "getir", "rafta"],
      en: ["read", "give", "bring", "shelf"],
    },
    phone: {
      tr: ["ara", "mesaj", "şarj", "ver"],
      en: ["call", "text", "charge", "give"],
    },
    person: {
      tr: ["gel", "git", "bekle", "kim"],
      en: ["come", "go", "wait", "who"],
    },
    window: {
      tr: ["aç", "kapat", "perde", "ışık"],
      en: ["open", "close", "curtain", "light"],
    },
    door: {
      tr: ["aç", "kapat", "kilitle", "bak"],
      en: ["open", "close", "lock", "check"],
    },
  },
  ...
  saveHistory() {
    try {
      localStorage.setItem("es_bigrams", JSON.stringify(this.userHistory));
    } catch (e) {}
  },
  ...
  predict(lastWord, prefix, n = 6) {
    ...
    Object.entries(this.userHistory).forEach(([key, freq]) => {
      ...
      if (lw && w1 === lw && (!lp || w2.startsWith(lp)))
        scored[w2] = (scored[w2] || 0) + freq * 5;
      else if (!lw && (!lp || w2.startsWith(lp)))
        scored[w2] = (scored[w2] || 0) + freq * 2;
    });

    // 2. Static dictionary bigrams (×3)
    const dictEntries = this.dictionary[lang] || {};
    if (lw && dictEntries[lw]) {
      dictEntries[lw].forEach((w) => {
        if (!lp || w.startsWith(lp)) scored[w] = (scored[w] || 0) + 30;
      });
    }
    ...
    this.lastDetectedObjects.forEach((obj) => {
      ...
      if (ctx) {
        ...
        words.forEach((w) => {
          if (!lp || w.startsWith(lp)) scored[w] = (scored[w] || 0) + 20;
        });
      }
    });
    ...
    base.forEach((w) => {
      if (!lp || w.startsWith(lp)) scored[w] = (scored[w] || 0) + 1;
    });

    // 5. User wFreq single words (×2)
    Object.entries(wFreq).forEach(([w, f]) => {
      if (!lp || w.startsWith(lp)) scored[w] = (scored[w] || 0) + f * 2;
    });
  ...
  detectLang(text) {
    ...
    const trWords =
      /\b(ve|bir|bu|için|ile|da|de|mi|mı|mu|mü|ben|sen|o|biz|siz|onlar|ama|veya)\b/i;
    const enWords =
      /\b(the|and|or|is|are|was|were|have|has|will|would|could|should|this|that|with|from)\b/i;
  ...
  onWordComplete(text) {
    ...
    if (words.length >= 3) {
      ...
      if (detected !== this.currentLang) {
        ...
        // Subtle notification
        showBlinkFlash(
          detected === "tr" ? "🌐 Türkçe algılandı" : "🌐 English detected",
        );
      }
    }
  },
...
let wFreq = {};
try {
  wFreq = JSON.parse(localStorage.getItem("es_wf") || "{}");
} catch (e) {}
...
function recWord(w) {
  ...
  wFreq[k] = (wFreq[k] || 0) + 1;
  try {
    localStorage.setItem("es_wf", JSON.stringify(wFreq));
  } catch (e) {}
}
...
// ════════════════════════════════════════════════════
// KEYBOARD v16 — 2-SEVİYELİ SATIR TARAMA MOTORU
// Döngü: Öneriler → Satır Seç → Tuş Seç → Eylemler → tekrar
// Tek blink = seç | Uzun göz kapatma (>900ms) = sıfırla/tamamla
// ════════════════════════════════════════════════════

// ── Tarama durumu
let lsActive = false;
let lsLevel = 0; // 0=öneriler, 1=satır_seçimi, 2=tuş_seçimi, 3=eylemler
let lsRowIndex = -1; // hangi satır seçili
let lsColIndex = -1; // hangi tuş seçili
let lsSuggIndex = -1; // hangi öneri
let lsActIndex = -1; // hangi eylem
let lsInterval = null;
let lsCurrentEl = null; // şu an vurgulanan element
let lsCurrentRow = null; // şu an vurgulanan satır elementi
let lsHighlightMs = 1000; // tarama hızı ms

// ── Blink algılama (sadece klavye açıkken)
let lsBlinkState = "open";
let lsBlinkCloseT = 0;
const LS_LONG_MS = 850; // uzun göz kapatma eşiği

// ── Tuş elementlerini satır satır topla
function lsGetRows() {
  const rows = [];
  document.querySelectorAll("#kbRows .kb-row").forEach((rowEl) => {
    const keys = [];
    rowEl.querySelectorAll(".kb-key").forEach((keyEl) => {
      const k = keyEl.dataset.key;
      if (k) keys.push({ el: keyEl, key: k });
    });
    if (keys.length) rows.push({ rowEl, keys });
  });
  return rows;
}
...
function lsGetSuggs() {
  const items = [];
  document.querySelectorAll("#kbSugg .kb-sg").forEach((el) => {
    const w = el.dataset.word || el.textContent.trim().split("\n")[0].trim();
    if (w) items.push({ el, word: w });
  });
  return items;
}

// ── Eylemleri topla
function lsGetActions() {
  const items = [];
  const tts = document.getElementById("kbTTS");
  const voice = document.getElementById("kbVoice");
  const back = document.getElementById("kbDelBtn");
  if (tts) items.push({ el: tts, action: "tts" });
  if (voice) items.push({ el: voice, action: "voice" });
  if (back) items.push({ el: back, action: "back" });
  return items;
}

// ── Bir elementi vurgula (sarı çerçeve)
function lsHilEl(el) {
  if (lsCurrentEl && lsCurrentEl !== el) {
    lsCurrentEl.classList.remove("ls-scanning");
  }
  lsCurrentEl = el;
  if (el) el.classList.add("ls-scanning");
}

// ── Bir satırı vurgula (tüm satır sarı çerçeve)
function lsHilRow(rowEl) {
  if (lsCurrentRow && lsCurrentRow !== rowEl) {
    lsCurrentRow.classList.remove("ls-row-scanning");
  }
  lsCurrentRow = rowEl;
  if (rowEl) rowEl.classList.add("ls-row-scanning");
}
...
function lsSetStatus(txt) {
  const lbl = document.getElementById("kbScanLabel");
  if (lbl) lbl.textContent = txt;
}

// ── Tarama adımı — her tick'te çağrılır
function lsTick() {
  if (!lsActive) return;

  if (lsLevel === 0) {
    // Öneri taraması
    const suggs = lsGetSuggs();
    if (!suggs.length) {
      // Öneri yok — direkt satır taramasına geç
      lsLevel = 1;
      lsSuggIndex = -1;
      lsColIndex = -1;
      lsRowIndex = -1;
      lsClear();
      lsSetStatus("SATIR TARA");
      return;
    }
    lsSuggIndex++;
    if (lsSuggIndex >= suggs.length) {
      // Öneriler bitti → satır taramasına geç
      lsLevel = 1;
      lsSuggIndex = -1;
      lsColIndex = -1;
      lsRowIndex = -1;
    ...
    lsHilEl(suggs[lsSuggIndex].el);
    lsHilRow(null);
    lsSetStatus("ÖNERİ TARA");
  } else if (lsLevel === 1) {
    // Satır taraması
    const rows = lsGetRows();
    if (!rows.length) {
      lsLevel = 3;
      lsActIndex = -1;
      lsClear();
    ...
    lsRowIndex++;
    if (lsRowIndex >= rows.length) {
      // Satırlar bitti → eylem taramasına geç
      lsLevel = 3;
      lsActIndex = -1;
      lsRowIndex = -1;
      lsClear();
      lsSetStatus("EYLEM TARA");
      return;
    }
    lsHilRow(rows[lsRowIndex].rowEl);
    lsHilEl(null);
    lsSetStatus("SATIR TARA — 👁 seç");
  } else if (lsLevel === 2) {
    // Tuş taraması (satır seçildi)
    const rows = lsGetRows();
    const row = rows[lsRowIndex];
    if (!row) {
      lsLevel = 1;
      lsRowIndex = -1;
      lsClear();
    ...
    lsColIndex++;
    if (lsColIndex >= row.keys.length) {
      // Satır bitti → aynı satıra geri dön → ya da satır seçimine
      lsColIndex = -1;
      lsLevel = 1;
      lsRowIndex = -1;
      lsClear();
    ...
    lsHilEl(row.keys[lsColIndex].el);
    lsSetStatus("TUŞ TARA — 👁 seç");
  } else if (lsLevel === 3) {
    // Eylem taraması
    const acts = lsGetActions();
    lsActIndex++;
    if (lsActIndex >= acts.length) {
      // Döngü başa dön
      lsLevel = 0;
      lsSuggIndex = -1;
      lsRowIndex = -1;
    ...
    lsHilEl(acts[lsActIndex].el);
    lsHilRow(null);
    lsSetStatus("EYLEM — 👁 seç");
  }
}
...
function lsSelect() {
  ...
  // Flash geri bildirimi
  if (lsCurrentEl) {
    lsCurrentEl.classList.add("ls-flash");
    const el = lsCurrentEl;
    setTimeout(() => el.classList.remove("ls-flash"), 280);
  }

  if (lsLevel === 0) {
    // Öneri seçimi
    const suggs = lsGetSuggs();
    const item = suggs[lsSuggIndex];
    if (!item) return;
    kbPickSugg(item.word);
    showBlinkFlash("✅ " + item.word);
    // Öneri seçildi → döngü başa
    lsLevel = 0;
    lsSuggIndex = -1;
    lsClear();
    lsSetStatus("ÖNERİ TARA");
  } else if (lsLevel === 1) {
    // Satır seçildi → tuş taramasına geç
    const rows = lsGetRows();
    const row = rows[lsRowIndex];
    if (!row) return;
    lsLevel = 2;
    lsColIndex = -1;
    // Satır çerçevesi kalır, hemen ilk tuşa geç
    lsSetStatus("TUŞ TARA — 👁 seç");
  } else if (lsLevel === 2) {
    // Tuş seçildi
    const rows = lsGetRows();
    const row = rows[lsRowIndex];
    if (!row) return;
    const item = row.keys[lsColIndex];
    if (!item) return;
    flashKey(item.el);
    kbAction(item.key);
    showBlinkFlash(
      "✅ " +
        (item.key === "SPACE" ? "␣" : item.key === "DEL" ? "⌫" : item.key),
    );
    // Tuş seçildi → aynı satırda kalmaya devam et (kolayca birden fazla tuş seçilsin)
    lsColIndex = -1;
    // Kısa bekle, tuş listesini güncelle (SHIFT sonrası değişebilir)
    setTimeout(() => {
      lsSetStatus("TUŞ TARA — 👁 seç");
    }, 100);
  } else if (lsLevel === 3) {
    // Eylem seçildi
    const acts = lsGetActions();
    const item = acts[lsActIndex];
    if (!item) return;
    if (item.action === "tts") {
      unlockTTS();
      const txt = kbText.trim();
      if (txt) speak(txt);
      else speak("Metin yok");
      showBlinkFlash("🔊 Okuyor…");
    } else if (item.action === "voice") {
      document.getElementById("kbVoice").click();
    } else if (item.action === "back") {
      kbAction("DEL");
      showBlinkFlash("⌫ Silindi");
    }
    lsActIndex = -1;
    lsLevel = 3;
  }
...
// ── Sıfırla (uzun göz kapatma)
function lsReset() {
  showBlinkFlash("🔄 Tarama sıfırlandı");
  ...
  lsClear();
  lsSetStatus("ÖNERİ TARA");
  lsInterval = setInterval(lsTick, lsHighlightMs);
}

// ── EAR işleme — DOĞRUDAN ham EAR kullan, smoothing yok
function lsProcessEAR(smooth, ts) {
  if (!lsActive) return;
  // Ham EAR daha duyarlı — earHistory[0] en son frame
  const rawEAR =
    earHistory.length > 0 ? earHistory[earHistory.length - 1] : smooth;
  // Daha duyarlı eşikler (mobil kamera için)
  const closeThresh = 0.2;
  const openThresh = 0.24;

  if (lsBlinkState === "open" && rawEAR < closeThresh) {
    lsBlinkState = "closed";
    lsBlinkCloseT = ts;
  } else if (lsBlinkState === "closed" && rawEAR >= openThresh) {
    const dur = ts - lsBlinkCloseT;
    lsBlinkState = "open";
    if (dur >= 40 && dur < 3000) {
      // 40ms-3000ms arası geçerli blink
      if (dur >= LS_LONG_MS) {
        lsReset();
        showBlinkFlash("🔄 Sıfırlandı");
      } else {
        lsSelect();
        showBlinkFlash("👁 Seçildi");
      }
    }
  } else if (lsBlinkState === "closed" && ts - lsBlinkCloseT > 3000) {
    lsBlinkState = "open"; // güvenlik sıfırlama
  }
}
...
function lsStart() {
  ...
  lsSuggIndex = -1;
  lsActIndex = -1;
  // Blink state sıfırla — önceki kalan state'i temizle
  lsBlinkState = "open";
  lsBlinkCloseT = 0;
  lsClear();
  lsSetStatus("ÖNERİ TARA");
  const bar = document.getElementById("kbScanStatus");
  if (bar) bar.style.display = "flex";
  // Klavye açıkken globalPanelBack'i gizle
  const gpb = document.getElementById("globalPanelBack");
...
function openKeyboard() {
  ...
  refreshKbDisplay();
  refreshSugg("");
  // Taramayı her zaman otomatik başlat
  setTimeout(lsStart, 400);
}
...
function closeKeyboard() {
  ...
  if (typeof hideVoiceOverlay === "function") hideVoiceOverlay();
}
...
function applyKbMode(m) {
  ...
  if (m === "touch") {
    ...
    if ($("kbPanel").style.display === "flex") setTimeout(lsStart, 200);
  }
}
...
function bindTouchHandlers() {
  ...
  const onClick = (e) => {
    ...
    if (kEl) {
      const kd = kbDwells.find((d) => d.el === kEl);
      if (kd) {
        flashKey(kEl);
        kbAction(kd.key);
      }
    ...
    if (sEl) {
      const sd = kbSuggDwells.find((d) => d.el === sEl);
      if (sd) kbPickSugg(sd.word);
    }
  };
...
function renderKB() {
  const rows = KB_LAYOUTS["alpha_en"];
  const c = $("kbRows");
  c.innerHTML = "";
  kbDwells = [];
  rows.forEach((row) => {
...
function refreshSugg(prefix) {
  ...
  if (!prefix.trim() && kbText.trim())
    contextSuggs = getContextSugg(kbText, 3).filter(
      (w) => !prefixSuggs.includes(w),
    );
  ...
  // Tarama öneri fazındaysa — mevcut index sınır dışıysa sıfırla
  if (lsActive && lsLevel === 0 && lsSuggIndex >= lsGetSuggs().length) {
    lsSuggIndex = lsGetSuggs().length - 1;
  }
}
...
// ── updateKbDwells: dokunmatik modda dwell hâlâ çalışır
// Göz modunda tarama motoru kullanılır (dwell gerekmez)
function updateKbDwells(gx, gy, dt) {
  ...
  kbDwells.forEach((kd) => {
    ...
    if (hit) {
      kd.elapsed += dt;
      kd.el.classList.add("gazing");
    } else {
      kd.elapsed = Math.max(0, kd.elapsed - dt * 1.6);
      if (!kd.elapsed) kd.el.classList.remove("gazing");
    }
  ...
  kbSuggDwells.forEach((sd) => {
    ...
    if (hit) {
      sd.elapsed += dt;
      sd.el.classList.add("gazing");
    } else {
      sd.elapsed = Math.max(0, sd.elapsed - dt * 1.6);
      if (!sd.elapsed) sd.el.classList.remove("gazing");
    }
...
function toggleBlinkKb() {
  /* v15: tarama modunda kullanılmıyor */
}
...
// ── Wiring
if ($("kbCloseBtn2")) $("kbCloseBtn2").onclick = closeKeyboard;
if ($("kbDelBtn"))
  $("kbDelBtn").onclick = () => {
    kbAction("DEL");
  };
...
function voiceConfirm(label, onConfirm) {
  ...
  speak(msg);
  showBlinkFlash(
    "👁 " + (appLang === "tr" ? "Göz kırp: Onayla" : "Blink: Confirm"),
  );
...
function stopVoice() {
  ...
  if (vb) {
    ...
    vb.textContent = "🎤 " + (appLang === "tr" ? "Ses" : "Voice");
  }
}
...
$("kbVoice").onclick = () => {
  ...
  if (!recognition) {
    $("kbVoice").textContent =
      appLang === "tr" ? "🎤 Desteklenmiyor" : "🎤 Unsupported";
  ...
  try {
    ...
    stopVoice();
    showVoiceOverlay(
      "⚠ " + (appLang === "tr" ? "Başlatılamadı" : "Could not start"),
    );
...
// ══════════════════════════════════════════════════════
const ppC = document.createElement("canvas");
ppC.width = 120;
ppC.height = 68;
const ppX = ppC.getContext("2d");
let lastLuma = 128,
  lightLevel = "normal"; // tracked globally for diagnostics
function updateBrightness() {
  ...
  try {
    ...
    if (av < 20) {
      lightLevel = "dark";
      lightWarn.style.display = "block";
      lightWarn.textContent = "⚠️ Low light";
    } else if (av < 40) {
      lightLevel = "low";
      lightWarn.style.display = "block";
      lightWarn.textContent = "⚠️ Light dim";
    } else {
      lightLevel = "normal";
      lightWarn.style.display = "none";
    }
...
video.addEventListener("playing", () => {
  setTimeout(updateBrightness, 1500);
});

// ══════════════════════════════════════════════════════
// DPI
// ══════════════════════════════════════════════════════
const dpiRuler = $("dpiRuler"),
  dpiHandle = $("dpiHandle");
let dpiWidth = 280;
function bindDpi(evD, evM, evU, gX) {
  dpiHandle.addEventListener(
    evD,
    (e) => {
      e.preventDefault();
      const x0 = gX(e),
        w0 = dpiRuler.offsetWidth;
      const mv = (ev) => {
        dpiWidth = Math.max(
          60,
          Math.min(window.innerWidth - 80, w0 + gX(ev) - x0),
        );
        dpiRuler.style.width = dpiWidth + "px";
        $("dpiPxV").textContent = Math.round(dpiWidth);
        $("dpiCmV").textContent = "10cm → " + Math.round(dpiWidth) + "px";
      };
      const up = () => {
        document.removeEventListener(evM, mv);
        document.removeEventListener(evU, up);
      };
      document.addEventListener(evM, mv);
      document.addEventListener(evU, up);
    },
    { passive: false },
  );
}
...
$("dpiSaveBtn").onclick = () => {
  pxPerCm = dpiWidth / 10;
  localStorage.setItem("es_pxcm", pxPerCm);
  $("dpiPanel").style.display = "none";
  speak(t("calibSaved"));
};
...
const COCO_MAP = {
  person: {
    tr: "Kişi",
    en: "Person",
    kbTR: ["kim", "gel", "bak", "yardım"],
    kbEN: ["who", "come", "look", "help"],
  },
  chair: {
    tr: "Sandalye",
    en: "Chair",
    kbTR: ["otur", "kalk", "yakın", "taşı"],
    kbEN: ["sit", "stand", "move", "closer"],
  },
  couch: {
    tr: "Kanepe",
    en: "Sofa",
    kbTR: ["otur", "uzan", "yardım"],
    kbEN: ["sit", "lie", "help"],
  },
  bed: {
    tr: "Yatak",
    en: "Bed",
    kbTR: ["uyu", "kalk", "minder", "yardım"],
    kbEN: ["sleep", "up", "pillow", "help"],
  },
  tv: {
    tr: "Televizyon",
    en: "TV",
    kbTR: ["kanal", "ses", "kapat", "aç"],
    kbEN: ["channel", "volume", "off", "on"],
  },
  "cell phone": {
    tr: "Telefon",
    en: "Phone",
    kbTR: ["ara", "mesaj", "şarj", "ver"],
    kbEN: ["call", "text", "charge", "give"],
  },
  laptop: {
    tr: "Bilgisayar",
    en: "Laptop",
    kbTR: ["aç", "kapat", "ekran"],
    kbEN: ["open", "close", "screen"],
  },
  book: {
    tr: "Kitap",
    en: "Book",
    kbTR: ["oku", "ver", "getir", "rafta"],
    kbEN: ["read", "give", "bring", "shelf"],
  },
  cup: {
    tr: "Bardak",
    en: "Cup",
    kbTR: ["su", "çay", "doldur", "boş"],
    kbEN: ["water", "tea", "fill", "empty"],
  },
  bottle: {
    tr: "Şişe",
    en: "Bottle",
    kbTR: ["su", "iç", "doldur", "ver"],
    kbEN: ["water", "drink", "fill", "give"],
  },
  bowl: {
    tr: "Kase",
    en: "Bowl",
    kbTR: ["yemek", "çorba", "ver", "sıcak"],
    kbEN: ["food", "soup", "give", "hot"],
  },
  fork: {
    tr: "Çatal",
    en: "Fork",
    kbTR: ["yemek", "getir", "nerede"],
    kbEN: ["food", "bring", "where"],
  },
  knife: {
    tr: "Bıçak",
    en: "Knife",
    kbTR: ["dikkat", "nerede", "ver"],
    kbEN: ["careful", "where", "give"],
  },
  spoon: {
    tr: "Kaşık",
    en: "Spoon",
    kbTR: ["yemek", "getir", "çorba"],
    kbEN: ["food", "bring", "soup"],
  },
  clock: {
    tr: "Saat",
    en: "Clock",
    kbTR: ["saat kaç", "zaman", "bekle"],
    kbEN: ["time", "what time", "wait"],
  },
  door: {
    tr: "Kapı",
    en: "Door",
    kbTR: ["aç", "kapat", "kilitle", "bak"],
    kbEN: ["open", "close", "lock", "check"],
  },
  window: {
    tr: "Pencere",
    en: "Window",
    kbTR: ["aç", "kapat", "perde", "ışık"],
    kbEN: ["open", "close", "curtain", "light"],
  },
  mouse: {
    tr: "Fare",
    en: "Mouse",
    kbTR: ["bilgisayar", "tıkla"],
    kbEN: ["computer", "click"],
  },
  keyboard: {
    tr: "Klavye",
  ...
  remote: {
    ...
    en: "Remote",
    kbTR: ["kanal", "ses", "tv"],
    kbEN: ["channel", "volume", "tv"],
  },
  umbrella: {
    tr: "Şemsiye",
    en: "Umbrella",
    kbTR: ["yağmur", "nerede", "ver"],
    kbEN: ["rain", "where", "give"],
  },
  backpack: {
    tr: "Sırt Çantası",
    en: "Backpack",
    kbTR: ["nerede", "ver", "hazır"],
    kbEN: ["where", "give", "ready"],
  },
  handbag: {
    tr: "Çanta",
    en: "Bag",
...
function cocoLabel(cls) {
  ...
  return {
    display: appLang === "tr" ? m.tr : m.en,
    kbWords: appLang === "tr" ? m.kbTR : m.kbEN,
  };
}
...
function _canCallApi() {
  return _canCallApiMode("vision");
}
function _markApiCalled() {
  _markApiCalledMode("vision");
}
function _handleApiSuccess() {
  _handleSuccessMode("vision");
}
function _handleApiRateLimit() {
  _handleRateLimitMode("vision");
}
...
async function callClaudeAPI(systemPrompt, userContent, mode = "vision") {
  ...
  if (!_canCallApiMode(mode)) {
    ...
    if (_canCallApiMode(fallbackMode) && getGeminiKey(fallbackMode)) {
      console.log(
        `[API] ${mode} mod cooldown'da, ${fallbackMode} anahtarıyla devam ediliyor`,
      );
      return callClaudeAPI(systemPrompt, userContent, fallbackMode);
    }
  ...
  const body = {
    contents: [
      ...
      {
        role: "model",
        parts: [{ text: "Anladım, talimatlarınıza uyacağım." }],
      },
      { role: "user", parts },
    ],
    generationConfig: {
      maxOutputTokens: 1024,
      temperature: mode === "ocr" ? 0.2 : 0.3,
      topP: 0.8,
    },
  };
  ...
  for (const model of GEMINI_MODELS) {
    ...
    if (!candidate) {
      lastError = "candidates boş";
      continue;
    }
    if (candidate.finishReason === "SAFETY") {
      throw new Error(
        appLang === "tr"
          ? "Güvenlik filtresi devreye girdi."
...
function vs(id, val, prop = "textContent") {
  const e = $(id);
  if (e) e[prop] = val;
}
function vsd(id, val) {
...
async function visionLoadCoco() {
  ...
  visionSetStatus(
    appLang === "tr"
      ? "🧠 Nesne tanıma modeli yükleniyor…"
  ...
  try {
    ...
    cocoLoading = false;
    visionSetStatus(
      appLang === "tr" ? "✅ Model hazır" : "✅ Model ready",
      "done",
    );
    return true;
  } catch (e) {
...
async function openVision() {
  if (!visionCheckSecurity()) {
    const vp = $("visionPanel");
  ...
  pushPage("visionPanel");
  vs("visionResultText", "");
  vsd("visionResult", "none");
  vsd("vpRepeatRow", "none");
  vsd("visionObjectStrip", "none");
  const op = $("visionObjectPills");
  if (op) op.innerHTML = "";
  ...
  vpCloseElapsed = 0;
  vpRepeatElapsed = 0;
  vs("visionScanDwell", "0%", "style.width");
  vs("vpOcrDwell", "0%", "style.width");
  ...
  speak(
    appLang === "tr"
      ? "Etrafımda ne var paneli açıldı. Kamera başlatılıyor."
      : "Vision panel opened. Starting camera.",
  );
...
async function visionStartCamera() {
  visionStopCamera();
  visionSetStatus(
    appLang === "tr" ? "📷 Kamera açılıyor…" : "📷 Opening camera…",
    "",
  );
  try {
    ...
    if (!vid) {
      visionSetStatus("❌ Video elementi bulunamadı", "error");
      return false;
    }
    vid.srcObject = visionStream;
    await vid.play();
    visionSetStatus(
      appLang === "tr" ? "✅ Kamera hazır" : "✅ Camera ready",
      "done",
    );
    const sb = $("visionScanBtn");
    if (sb) sb.disabled = false;
    // Update cam switch label — null-safe
    const sw = $("visionCamSwitch");
    if (sw) {
      const lbl =
        sw.querySelector("#visionCamSwitchLabel") ||
        sw.querySelector("span:last-child");
      if (lbl)
        lbl.textContent =
          visionFacingMode === "environment"
            ? appLang === "tr"
              ? "Ön Kamera"
              : "Front Cam"
            : appLang === "tr"
...
function visionStopCamera() {
  ...
  const v = $("visionPreviewVideo");
  if (v) v.srcObject = null;
}

async function visionSwitchCamera() {
  visionFacingMode =
    visionFacingMode === "environment" ? "user" : "environment";
  visionStopDetectionLoop();
...
function _startCountdown(until) {
  ...
  _countdownTimer = setInterval(() => {
    ...
    if (remaining <= 0) {
      ...
      visionSetStatus(
        appLang === "tr"
          ? "✅ Hazır — tekrar tarayabilirsiniz"
          : "✅ Ready — you can scan again",
        "done",
      );
      return;
    }
...
function _shouldSpeak(key) {
  const now = Date.now();
  if (spokenLog.has(key) && now - spokenLog.get(key) < SPOKEN_LOG_TTL)
    return false;
...
function _computeSceneHash(vid) {
  if (!_sceneCanvas) {
    ...
    _sceneCanvas.width = 16;
    _sceneCanvas.height = 12;
  ...
  for (let i = 0; i < d.length; i += 4)
    hash += d[i] * 0.3 + d[i + 1] * 0.59 + d[i + 2] * 0.11;
  return hash;
}
...
function _checkDangers(preds) {
  const dangers = preds.filter(
    (p) => p.score >= VISION_OBJECT_MIN_SCORE && DANGER_CLASSES.has(p.class),
  );
  ...
  async function detectFrame(ts) {
    ...
    if (cocoLoaded && ts - lastDetectTime >= DETECT_INTERVAL) {
      ...
      if (!_ocrRunning && !_ocrSpeaking) {
        ...
        const hasDangerNew = lastCocoDetections.some(
          (p) =>
      ...
      if (!_ocrPending && !_ocrRunning && !_ocrSpeaking && !_dangerLock) {
        ...
        if (density >= 0.15) {
          if (!_ocrWarned) {
            ...
            visionSetStatus(
              appLang === "tr"
                ? "📖 Metin algılandı, okunuyor…"
                : "📖 Text detected, reading…",
              "analyzing",
            );
            speak(
              appLang === "tr"
...
function visionStopDetectionLoop() {
  if (visionDetectRafId) {
    cancelAnimationFrame(visionDetectRafId);
    visionDetectRafId = null;
  }
}
...
async function visionRunCoco() {
  ...
  try {
    ...
    kbEngine.lastDetectedObjects = [
      ...new Set(predictions.map((p) => p.class.toLowerCase())),
    ];
  } catch (e) {
    console.warn("[COCO]", e.message);
  }
}
...
function visionUpdateGazeZones(preds, videoW, videoH) {
  ...
  if (!videoW) return;
  const scaleX = wrap.clientWidth / videoW,
    scaleY = wrap.clientHeight / videoH;
  preds
    .filter((p) => p.score >= VISION_OBJECT_MIN_SCORE)
    .forEach((p) => {
      const [x, y, w, h] = p.bbox;
...
function updateVisionDwells(gx, gy, dt) {
  ...
  function dwellBtn(btnId, dwellId, elapsed, onTrigger) {
    const btn = $(btnId);
    if (!btn || btn.disabled) return elapsed;
    const r = btn.getBoundingClientRect();
    const inside =
      gx >= r.left && gx <= r.right && gy >= r.top && gy <= r.bottom;
    if (inside) {
      elapsed += dt;
      btn.classList.add("gazing");
    } else {
      elapsed = Math.max(0, elapsed - dt * 2);
      btn.classList.remove("gazing");
    }
    const pct = Math.min(1, elapsed / (DWELL_MS * 1.2));
    const dw = $(dwellId);
    if (dw) dw.style.width = pct * 100 + "%";
    if (pct >= 1) {
      elapsed = 0;
      btn.classList.remove("gazing");
      if (dw) dw.style.width = "0%";
      onTrigger();
    }
    return elapsed;
  }

  visionScanElapsed = dwellBtn(
    "visionScanBtn",
    "visionScanDwell",
    visionScanElapsed,
    () => visionAnalyze(),
  );
  vpOcrElapsed = dwellBtn("vpOcrBtn", "vpOcrDwell", vpOcrElapsed, () =>
    vpRunOcr(),
  );
  vpRepeatElapsed = dwellBtn(
    "visionRepeatBtn",
    "visionRepeatDwell",
    vpRepeatElapsed,
    () => visionRepeatTTS(),
  );
  vpCloseElapsed = dwellBtn(
    "visionCloseBtn",
    "visionCloseDwell",
    vpCloseElapsed,
    () => closeVision(),
  ...
  visionGazeZoneDwells.forEach((z) => {
    ...
    if (inside) {
      z.elapsed += dt;
      z.el.classList.add("vgz-dwelling");
    } else {
      z.elapsed = Math.max(0, z.elapsed - dt * 2);
      z.el.classList.remove("vgz-dwelling");
    }
    const pct = Math.min(1, z.elapsed / (DWELL_MS * 1.5));
    z.dwell.style.width = pct * 100 + "%";
    if (pct >= 1) {
      z.elapsed = 0;
      z.dwell.style.width = "0%";
      visionSpeakObject(z.cls);
    }
  });
}
...
function visionOfflineSummary() {
  const preds = lastCocoDetections.filter(
    (p) => p.score >= VISION_OBJECT_MIN_SCORE,
  );
  if (!preds.length) {
    return appLang === "tr"
...
function visionSpeakObject(cls) {
  ...
  // Tekrar filtresi
  if (
    _spokenObjects.has(cls) &&
    now - _spokenObjects.get(cls) < SPOKEN_COOLDOWN_MS
  )
    return;
  ...
  if (pred) {
    ...
    if (isDanger) {
      announcement =
        appLang === "tr"
          ? `DİKKAT! ${display} ${dir}, ${dist}`
          : `WARNING! ${display} ${dir}, ${dist}`;
...
function visionToggleAuto() {
  ...
  if (visionAutoEnabled) {
    ...
    if (icon) icon.textContent = "⏸";
    if (lbl) lbl.textContent = appLang === "tr" ? "Otomatik" : "Auto";
    const arc = $("visionAutoArc");
    if (arc) arc.style.strokeDashoffset = 113;
    const al = document.getElementById("visionAutoLabel");
    if (al) al.textContent = "1.5s";
  }
}
function visionStopAuto() {
  visionAutoEnabled = false;
  visionAutoElapsed = 0;
}
...
function visionSetMode(mode) {
  ...
  if (isOcr) {
    ...
    if (sub)
      sub.textContent =
        appLang === "tr"
          ? "Kamerayı metne tutun, otomatik okunur"
          : "Hold camera over text — auto reads";
  } else {
    if (icon) icon.textContent = "🔍";
    if (title)
      title.textContent =
        appLang === "tr" ? "Etrafımda Ne Var?" : "What's Around Me?";
    if (sub)
      sub.textContent =
        appLang === "tr" ? "Yapay Zeka Görme Asistanı" : "AI Vision Assistant";
  }

  // Scan button label
  const si = $("visionScanIcon"),
    sl = $("visionScanLabel");
  ...
  if (isOcr) {
    ...
    visionSetStatus(
      appLang === "tr"
        ? "📖 Hazır — Tara butonuna bakın"
        : "📖 Ready — Look at scan button",
      "",
    );
    speak(
      appLang === "tr"
        ? "Metin okuma modu. Tara butonuna bakın."
        : "Text read mode. Look at the scan button.",
    );
  } else {
    ocrStopCountdown();
...
function updateOcrCountdownUI(pct) {
  ...
  if (hint)
    hint.textContent =
      pct > 0.05
        ? appLang === "tr"
          ? `${Math.ceil((OCR_COUNTDOWN_MS * (1 - pct)) / 1000)} saniye…`
          : `${Math.ceil((OCR_COUNTDOWN_MS * (1 - pct)) / 1000)}s…`
        : t("ocrHintShort");
}
...
async function ocrAnalyze() {
  ...
  vsb("visionScanBtn", true);
  vs("visionScanIcon", "⏳");
  vs("visionScanLabel", appLang === "tr" ? "Okunuyor…" : "Reading…");
  visionSetStatus(t("ocrAnalyzing"), "analyzing");
  vsd("visionResult", "none");
  vsd("visionRepeatBtn", "none");
...
If no text is found, write ONLY: NONE`;
    ...
    const userContent = [
      ...
      },
      {
        ...
        text:
          appLang === "tr"
            ? "Bu görüntüdeki tüm metinleri oku."
    ...
    const hasNoText = noTextMarkers.some(
      (m) => text.toLowerCase().includes(m.toLowerCase()) && text.length < 20,
    );
    ...
    vsd("visionRepeatBtn", "flex");
    vs(
      "visionResultLabel",
      appLang === "tr" ? "📖 Okunan Metin" : "📖 Read Text",
    );
    vs("visionScanIcon", "📖");
    ...
    visionSetStatus(
      "❌ " + (appLang === "tr" ? "Hata: " : "Error: ") + e.message,
      "error",
    );
    vs("visionScanIcon", "📖");
    vs("visionScanLabel", t("ocrScan"));
    vsb("visionScanBtn", false);
    visionScanElapsed = 0;
    vs("visionScanDwell", "0%", "style.width");
    speak(t("ocrError"));
...
async function visionAnalyze() {
  ...
  try {
    const imageBase64 = await visionCapture();
    const cocoHint = lastCocoDetections.length
      ? appLang === "tr"
...
Last line write only (user won't see): OBJECTS:obj1,obj2,obj3`;
    const userContent = [
      ...
      },
      {
        ...
        text:
          (appLang === "tr"
            ? "Etrafımda ne var? Yön ve mesafe bilgisiyle anlat."
            : "What is around me? Describe with directions and distances.") +
          cocoHint,
      },
    ];
    let fullText;
    try {
      ...
      console.warn(
        "[Vision] API failed, using offline fallback:",
        apiErr.message,
      );
      ...
      visionSetStatus(
        appLang === "tr"
          ? "⚠ Çevrimiçi erişim yok, yerel algılama kullanılıyor"
          : "⚠ Offline — using local detection",
        "",
      );
    }
    ...
    if (objLineMatch) {
      try {
        const objs = objLineMatch[1]
          .split(",")
          .map((o) => o.trim().toLowerCase())
          .filter(Boolean);
        kbEngine.lastDetectedObjects = objs;
        const ctxWords = objs
          .filter((o) => kbEngine.contextVocab[o])
          .flatMap((o) =>
            (kbEngine.contextVocab[o][appLang] || []).slice(0, 2),
          );
        if (ctxWords.length)
          showBlinkFlash(
            (appLang === "tr" ? "💡 Öneriler: " : "💡 Hints: ") +
              ctxWords.slice(0, 3).join(", "),
          );
      } catch (e) {}
    ...
    if (objJson) {
      fullText = fullText.replace(/\{"objects":\s*\[[^\]]*\]\}/, "").trim();
    }
    if (!fullText)
      throw new Error(
        appLang === "tr" ? "Açıklama alınamadı" : "No description received",
      );
    visionLastDescription = fullText;
    vs("visionResultText", fullText);
    vs(
      "visionResultLabel",
      appLang === "tr" ? "🔍 Etraf Analizi" : "🔍 Scene Analysis",
    );
    vsd("visionResult", "block");
    vsd("vpRepeatRow", "flex"); // ← doğru eleman
    visionSetStatus(
      appLang === "tr" ? "✅ Analiz tamamlandı" : "✅ Analysis complete",
      "done",
    );
    vs("visionScanLabel", appLang === "tr" ? "Tekrar Tara" : "Scan Again");
    vsb("visionScanBtn", false);
    ...
    vs(
      "visionResultLabel",
      appLang === "tr" ? "📡 Yerel Algılama" : "📡 Local Detection",
    );
    vsd("visionResult", "block");
...
async function _initTesseract() {
  ...
  _tessLoading = true;
  setOcrLensStatus(
    appLang === "tr" ? "🔤 OCR motoru yükleniyor…" : "🔤 Loading OCR…",
  );
  try {
...
async function _runHybridOcr() {
  ...
  if (_tessReady) {
    try {
      setOcrLensStatus(
        appLang === "tr" ? "🔍 Tesseract tarıyor…" : "🔍 Tesseract scanning…",
      );
      const lc = $("ocrLensCanvas");
      ...
      _drawLensBoxes(W, H);
      setOcrLensStatus(
        `📦 ${_lensWords.length} ${appLang === "tr" ? "kutu" : "boxes"} — Gemini doğruluyor…`,
      );
    } catch (e) {
      console.warn("[Tesseract]", e.message);
    }
  ...
  if (!_canCallApiMode("ocr")) {
    ...
    if (cleaned) {
      setOcrLensStatus(
        appLang === "tr"
          ? "⏳ API meşgul, Tesseract kullanıldı"
          : "⏳ API busy, used Tesseract",
      );
      setTimeout(() => {
        _clearLensCanvas();
        _lensWords = [];
      ...
      setOcrLensStatus(
        appLang === "tr" ? "⏳ API meşgul, metin yok" : "⏳ API busy, no text",
      );
    }
    return cleaned;
  }
...
- If no text: write "No text found in image."`;
    ...
    const userContent = [
      ...
      },
      {
        ...
        text:
          appLang === "tr"
            ? "Anlamlı metinleri oku, gürültüleri yoksay."
            : "Read meaningful text, ignore noise.",
      },
    ];
    ...
    if (cleaned) {
      setOcrLensStatus(
        appLang === "tr"
          ? "⚠ Gemini hata, Tesseract kullanıldı"
          : "⚠ Gemini failed, Tesseract used",
      );
    } else {
      setOcrLensStatus(
        appLang === "tr"
          ? "⚠ Gemini hata, metin yok"
          : "⚠ Gemini failed, no text",
      );
    }
    setTimeout(() => {
      _clearLensCanvas();
...
async function vpRunOcr(autonomous = false) {
  ...
  visionSetStatus(
    appLang === "tr" ? "📷 Odaklanıyor…" : "📷 Focusing…",
    "analyzing",
  );
  await new Promise((r) => setTimeout(r, 500));
  visionSetStatus(
    appLang === "tr" ? "📖 Yazı okunuyor…" : "📖 Reading text…",
    "analyzing",
  );
  speak(
    appLang === "tr"
      ? "Yazı okunuyor, lütfen bekleyin."
  ...
  try {
    ...
    const isNoText =
      cleaned.includes("bulunamadı") || cleaned.includes("No text found");
    ...
    vs(
      "visionResultLabel",
      appLang === "tr" ? "📖 Okunan Yazı" : "📖 Read Text",
    );
    vsd("visionResult", "block");
    vsd("vpRepeatRow", "flex");
    visionSetStatus(
      appLang === "tr" ? "✅ Yazı okundu" : "✅ Text read",
      "done",
    );
    vs("vpOcrLabel", appLang === "tr" ? "Yazı Oku" : "Read Text");
    _ocrRunning = false;
    ...
    _ocrSpeaking = true;
    _speakOcrText(cleaned, () => {
      _ocrSpeaking = false;
    });
  } catch (e) {
    const fallback =
      appLang === "tr" ? `Hata: ${e.message}` : `Error: ${e.message}`;
    vs("visionResultText", fallback);
    vsd("visionResult", "block");
...
function visionRepeatTTS() {
  if (visionLastDescription) speak(visionLastDescription);
}
...
function applyVisionI18n() {
  ...
  set(
    "visionObjectsLabel",
    appLang === "tr" ? "Algılanan Nesneler" : "Detected Objects",
  );
  ...
  set(
    "vpScanSub",
    appLang === "tr"
      ? "Bakıp bekle → AI anlatır"
      : "Look & hold → AI describes",
  );
  set(
    "vpOcrSub",
    appLang === "tr"
      ? "Kamerayı yazıya tut → okur"
      : "Hold at text → reads aloud",
  );
}
...
function hideAllScreens() {
  [startScreen, calibScreen, evalScreen, reportScreen].forEach((s) =>
...
function directEntry() {
  ...
  showMainMode();
  speak(
    appLang === "tr" ? "Dokunmatik modda girildi." : "Entered in touch mode.",
  );
}
...
function showMainMode() {
  ...
  irisQ.style.display = "block";
  mainDwells = [];
  updateGazeBackVisibility();
  startLocationTracking();
  applyI18n();
  // inputMode'a göre dot görünürlüğünü ayarla
  const showDot =
    inputMode === "eye" || inputMode === "both" || inputMode === "dwellonly";
  dot.style.display = showDot ? "block" : "none";
  dwellRing.style.display = showDot ? "block" : "none";
  // dot rengini sıfırla
  dot.style.background = "radial-gradient(circle at 35% 35%,#ffee88,#cc1111)";
  dot.style.boxShadow =
    "0 0 0 3px rgba(255,0,0,0.18),0 0 14px rgba(255,80,0,0.45)";
...
function startLocationTracking() {
  ...
  locationWatchId = navigator.geolocation.watchPosition(
    ...
    (err) => {
      const c = JSON.parse(localStorage.getItem("es_loc") || "null");
      if (c) {
        setLocVal(c.d);
      } else {
        setLocVal(err.code === 1 ? t("locDenied") : t("locError"));
      }
    },
...
async function reverseGeocode(lat, lon) {
  try {
    const r = await fetch(
      `https://nominatim.openstreetmap.org/reverse?lat=${lat}&lon=${lon}&format=json&accept-language=${appLang}`,
    );
    ...
    setLocVal(label);
    try {
      localStorage.setItem("es_loc", JSON.stringify({ d: label, lat, lon }));
    } catch (e) {}
  } catch {
    setLocVal(`${lat.toFixed(4)}, ${lon.toFixed(4)}`);
  }
}
function setLocVal(v) {
...
function updatePanicDwell(gx, gy, dt) {
  ...
  if (inside) {
    ...
    panicElapsed = Math.max(0, panicElapsed - dt * 2);
    btn.classList.remove("gazing");
  }
  const pct = Math.min(1, panicElapsed / (DWELL_MS * 2));
  const dw = document.getElementById("panicDwell");
  if (dw) dw.style.width = pct * 100 + "%";
  if (pct >= 1) {
    panicElapsed = 0;
    if (dw) dw.style.width = "0%";
...
function initStart() {
  ...
  if (ok) {
    ...
    $("savedInfo").innerHTML =
      '<span class="calib-ready-badge"><span class="cr-dot"></span>' +
      t("calibReadyLabel") +
      "</span>";
  ...
  $("startFreshBtn").onclick = () => {
    ...
    if (!cameraReady) {
      main().then(() => {
        if (cameraReady) startCalibration();
      });
    } else {
      startCalibration();
    }
...
async function main() {
  // [see source for notes]
  $("startFreshBtn").textContent =
    appLang === "tr" ? "⏳ Kamera yükleniyor…" : "⏳ Loading camera…";
...
function mainFaceMeshHandler(res) {
  ...
  // Kalibrasyon sırasında iris pozisyonunu dot  // Kalibrasyon sırasında feat kullanarak gaze dot güncelle
  if (calibActive && feat) {
    const eyeX = feat[4];
    const eyeY = feat[5];
    // Ham göz tahmini
    const rawX = window.innerWidth / 2 - eyeX * window.innerWidth * 2.8;
    const rawY = window.innerHeight / 2 + eyeY * window.innerHeight * 3.2;
    // Hedef nokta (turuncu kalibrasyon noktası)
    const targetPt = calibAllPts[calibIdx];
    if (targetPt) {
      const tx = targetPt[0] * window.innerWidth;
      const ty = targetPt[1] * window.innerHeight;
      // Mıknatıs: ham tahmin ile hedef arasında karma — toplama süresi ilerledikçe hedefe yaklaş
      const collectProgress = calibCollecting
        ? Math.min(1, (Date.now() - calibCollectStart) / DWELL_MS)
        : 0;
      const magnetStrength = 0.3 + collectProgress * 0.5; // 0.3 → 0.8
      const blendX = rawX + (tx - rawX) * magnetStrength;
      const blendY = rawY + (ty - rawY) * magnetStrength;
      smX += 0.14 * (blendX - smX);
      smY += 0.14 * (blendY - smY);
    } else {
      smX += 0.12 * (rawX - smX);
    ...
    const gx = Math.max(10, Math.min(window.innerWidth - 10, smX));
    const gy = Math.max(10, Math.min(window.innerHeight - 10, smY));
  ...
  const avgPose = {
    yaw:
      headPoseHistory.reduce((s, p) => s + p.yaw, 0) / headPoseHistory.length,
    pitch:
      headPoseHistory.reduce((s, p) => s + p.pitch, 0) / headPoseHistory.length,
  };
  const featPoly = polyExpand(feat);
  let tx = predict(modelX, featPoly),
    ty = predict(modelY, featPoly);
  tx += avgPose.yaw * window.innerWidth * 0.06;
  ty += avgPose.pitch * window.innerHeight * 0.045;
  const dt = ts - latestTs;
  latestTs = ts;
  frameTimes.push(dt);
  ...
  const baseAlpha = kbOpen
    ? Math.max(
        0.03,
        ALPHA * (kbSensitivity === 3 ? 1.2 : kbSensitivity === 1 ? 0.6 : 1.0),
      )
    : ALPHA;
  // Adaptive: hızlı bakışta daha duyarlı, sabit bakışta daha stabil
  const _speed = Math.hypot(tx - smX, ty - smY);
  const _sn = Math.min(1, _speed / (window.innerWidth * 0.25));
  const _alpha = Math.max(0.02, Math.min(0.35, baseAlpha * (0.4 + _sn * 1.2)));
  // Deadzone: 18px altında imleç kıpırdamaz
  if (_speed >= 18) {
    smX += _alpha * (tx - smX);
    smY += _alpha * (ty - smY);
  }
  let _gx = Math.max(4, Math.min(window.innerWidth - 4, smX));
  let _gy = Math.max(4, Math.min(window.innerHeight - 4, smY));
  // Snap-to-target: Apple VisionOS benzeri mıknatıs etkisi
  const _snap = findSnapTarget(_gx, _gy);
  if (_snap) {
    _gx += (_snap.cx - _gx) * _snap.strength;
    _gy += (_snap.cy - _gy) * _snap.strength;
  }
  dot.style.left = _gx + "px";
  dot.style.top = _gy + "px";
  dwellRing.style.left = _gx + "px";
  dwellRing.style.top = _gy + "px";
  dispatchGaze(_gx, _gy, Math.min(dt, 80));
...
// ══════════════════════════════════════════════════════
let irisScrollEnabled = JSON.parse(
  localStorage.getItem("es_irisScroll") || "true",
);
...
function getScrollPanel() {
  ...
  if (reportScreen && !reportScreen.classList.contains("hidden")) {
    ...
    return {
      el: reportScreen,
      rect: reportScreen.getBoundingClientRect(),
    };
  }
...
function updateIrisScroll(gx, gy) {
  ...
  const inPanel =
    relY >= 0 && relY <= rect.height && gx >= rect.left && gx <= rect.right;
  ...
  if (relY < zoneH) {
    ...
    if (topEl) {
      topEl.classList.add("visible", "active");
    }
    if (botEl) {
      botEl.classList.remove("active");
      botEl.classList.add("visible");
      botEl.style.opacity = "0.3";
    }
    ...
    irisScrollVel = depth * IRIS_SCROLL_SPEED;
    if (botEl) {
      botEl.classList.add("visible", "active");
      botEl.style.opacity = "";
    }
    if (topEl) {
      topEl.classList.remove("active");
      topEl.classList.add("visible");
      topEl.style.opacity = "0.3";
    }
  } else {
    // Middle — no scroll, hide zones
    irisScrollVel *= 0.6;
    if (topEl) {
      topEl.classList.remove("active", "visible");
      topEl.style.opacity = "";
    }
    if (botEl) {
      botEl.classList.remove("active", "visible");
      botEl.style.opacity = "";
    }
  }
}
...
let hapticEnabled = JSON.parse(localStorage.getItem("es_haptic") || "false");
let audioFeedbackEnabled = JSON.parse(
  localStorage.getItem("es_audioFb") || "false",
);

function toggleHaptic() {
  hapticEnabled = !hapticEnabled;
  localStorage.setItem("es_haptic", hapticEnabled);
  const card = $("hapticCard");
  if (card) card.classList.toggle("active", hapticEnabled);
  const lbl = $("hapticLabel");
  if (lbl)
    lbl.textContent = hapticEnabled
      ? appLang === "tr"
        ? "Açık ✓"
        : "On ✓"
      : appLang === "tr"
        ? "Kapalı"
        : "Off";
  if (hapticEnabled && navigator.vibrate) navigator.vibrate([40, 30, 40]);
}

function toggleAudioFeedback() {
  audioFeedbackEnabled = !audioFeedbackEnabled;
  localStorage.setItem("es_audioFb", audioFeedbackEnabled);
  const card = $("audioFbCard");
  if (card) card.classList.toggle("active", audioFeedbackEnabled);
  const lbl = $("audioFbLabel");
  if (lbl)
    lbl.textContent = audioFeedbackEnabled
      ? appLang === "tr"
        ? "Açık ✓"
        : "On ✓"
      : appLang === "tr"
  ...
  if (audioFeedbackEnabled)
    speak(appLang === "tr" ? "Sesli geri bildirim açık" : "Audio feedback on");
}

// Slider hover/change haptic feedback
function a11yHaptic() {
  if (hapticEnabled && navigator.vibrate) navigator.vibrate(20);
}

// A11Y slider helpers
function a11yAdjDwell(dir) {
  const sl = document.getElementById("a11yDwellSl");
  sl.value = Math.max(5, Math.min(50, parseInt(sl.value) + dir * 2));
  sl.dispatchEvent(new Event("input"));
  if (hapticEnabled && navigator.vibrate) navigator.vibrate(30);
}
function a11yAdjAlpha(dir) {
  const sl = document.getElementById("a11yAlphaSl");
  sl.value = Math.max(2, Math.min(60, parseInt(sl.value) + dir * 3));
  sl.dispatchEvent(new Event("input"));
  if (navigator.vibrate) navigator.vibrate(30);
}
function a11yAdjKb(dir) {
  const sl = document.getElementById("kbSensSl");
  sl.value = Math.max(1, Math.min(3, parseInt(sl.value) + dir));
  sl.dispatchEvent(new Event("input"));
  setKbSensitivity(sl.value);
  if (navigator.vibrate) navigator.vibrate(30);
}

// ── KALİBRASYON KAMERA ÖNİZLEME ──
let calibCamStream = null;
let calibCollectStart = 0;

function startCalibCamPreview() {
  const vid = document.getElementById("calibCamVideo");
  const wrap = document.getElementById("calibCamWrap");
  if (!vid || !wrap) return;
  // Zaten aktif stream varsa direkt kullan
  if (activeStream) {
...
function stopCalibCamPreview() {
  const wrap = document.getElementById("calibCamWrap");
  if (wrap) wrap.style.display = "none";
  // calibCamStream'i durdur — activeStream değilse
  if (calibCamStream && calibCamStream !== activeStream) {
    calibCamStream.getTracks().forEach((t) => t.stop());
    calibCamStream = null;
  }
}

// Mini kamera fonksiyonu
let miniCamStream = null;
function startMiniCam() {
  const vid = document.getElementById("miniCamVideo");
  const wrap = document.getElementById("miniCamWrap");
  if (!vid || !wrap) return;
  if (activeStream) {
    vid.srcObject = activeStream;
    vid.play().catch(() => {});
  ...
  navigator.mediaDevices
    .getUserMedia({
      video: { facingMode: "user", width: 120, height: 90 },
    })
    .then((s) => {
      miniCamStream = s;
      vid.srcObject = s;
